...
* Raw input strings are escaped to prevent Cross-Site Scripting (XSS).`,updatedAt:Date.now(),tags:["security","hardening"],isSystem:!0}];async function so(){if((await Ht()).length===0)for(const e of wa)await dn(e)}async function ms(){const o=await he();return new Promise((e,t)=>{const n=[Be,Ue,"tagColors","attachments","auditLogs"],s=o.transaction(n,"readwrite"),a=s.objectStore(Be),r=s.objectStore(Ue),i=s.objectStore("tagColors"),l=s.objectStore("attachments"),d=s.objectStore("auditLogs");a.clear(),r.clear(),i.clear(),l.clear(),d.clear(),s.oncomplete=()=>e(),s.onerror=()=>t(s.error)})}async function gs(){const o=await he();return new Promise((e,t)=>{try{const a=o.transaction("tagColors","readonly").objectStore("tagColors").getAll();a.onerror=()=>t(a.error),a.onsuccess=()=>e(a.result||[])}catch{e([])}})}async function va(o){const e=await he();return new Promise((t,n)=>{const r=e.transaction("tagColors","readwrite").objectStore("tagColors").put(o);r.onerror=()=>n(r.error),r.onsuccess=()=>t()})}async function Ea(o){const e=await he();return new Promise((t,n)=>{const r=e.transaction("attachments","readwrite").objectStore("attachments").put(o);r.onerror=()=>n(r.error),r.onsuccess=()=>t()})}async function zo(o){const e=await he();return new Promise((t,n)=>{try{const r=e.transaction("attachments","readonly").objectStore("attachments").get(o);r.onerror=()=>n(r.error),r.onsuccess=()=>t(r.result||null)}catch{t(null)}})}async function ka(){const o=await he();return new Promise((e,t)=>{try{const a=o.transaction("attachments","readonly").objectStore("attachments").getAll();a.onerror=()=>t(a.error),a.onsuccess=()=>e(a.result||[])}catch{e([])}})}async function Sa(o){const e=await he();return new Promise((t,n)=>{try{const r=e.transaction("auditLogs","readwrite").objectStore("auditLogs").put(o);r.onerror=()=>n(r.error),r.onsuccess=()=>t()}catch(s){console.error("Audit logging transaction failed:",s),t()}})}async function Ta(){const o=await he();return new Promise((e,t)=>{try{const a=o.transaction("auditLogs","readonly").objectStore("auditLogs").getAll();a.onerror=()=>t(a.error),a.onsuccess=()=>{const r=a.result||[];r.sort((i,l)=>l.timestamp-i.timestamp),e(r)}}catch{e([])}})}async function Ia(){const o=await he();return new Promise((e,t)=>{const a=o.transaction("auditLogs","readwrite").objectStore("auditLogs").clear();a.onerror=()=>t(a.error),a.onsuccess=()=>e()})}async function hs(o){const e=await he(),t=Date.now()-o*24*60*60*1e3;return new Promise((n,s)=>{try{const i=e.transaction("auditLogs","readwrite").objectStore("auditLogs").openCursor();i.onerror=()=>s(i.error),i.onsuccess=()=>{const l=i.result;l?(l.value.timestamp<t&&l.delete(),l.continue()):n()}}catch(a){s(a)}})}async function Aa(o){const e=await he();return new Promise((t,n)=>{const r=e.transaction("backups","readwrite").objectStore("backups").put(o);r.onerror=()=>n(r.error),r.onsuccess=()=>t()})}/*! @license DOMPurify 3.4.11 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.11/LICENSE */function jo(o,e){(e==null||e>o.length)&&(e=o.length);for(var t=0,n=Array(e);t<e;t++)n[t]=o[t];return n}function La(o){if(Array.isArray(o))return o}function Ca(o,e){var t=o==null?null:typeof Symbol<"u"&&o[Symbol.iterator]||o["@@iterator"];if(t!=null){var n,s,a,r,i=[],l=!0,d=!1;try{if(a=(t=t.call(o)).next,e!==0)for(;!(l=(n=a.call(t)).done)&&(i.push(n.value),i.length!==e);l=!0);}catch(p){d=!0,s=p}finally{try{if(!l&&t.return!=null&&(r=t.return(),Object(r)!==r))return}finally{if(d)throw s}}return i}}function Ra(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Da(o,e){return La(o)||Ca(o,e)||$a(o,e)||Ra()}function $a(o,e){if(o){if(typeof o=="string")return jo(o,e);var t={}.toString.call(o).slice(8,-1);return t==="Object"&&o.constructor&&(t=o.constructor.name),t==="Map"||t==="Set"?Array.from(o):t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?jo(o,e):void 0}}const bs=Object.entries,Ho=Object.setPrototypeOf,_a=Object.isFrozen,Oa=Object.getPrototypeOf,Na=Object.getOwnPropertyDescriptor;let Se=Object.freeze,Te=Object.seal,xt=Object.create,xs=typeof Reflect<"u"&&Reflect,Yn=xs.apply,Zn=xs.construct;Se||(Se=function(e){return e});Te||(Te=function(e){return e});Yn||(Yn=function(e,t){for(var n=arguments.length,s=new Array(n>2?n-2:0),a=2;a<n;a++)s[a-2]=arguments[a];return e.apply(t,s)});Zn||(Zn=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),s=1;s<t;s++)n[s-1]=arguments[s];return new e(...n)});const Rt=ge(Array.prototype.forEach),Pa=ge(Array.prototype.lastIndexOf),Fo=ge(Array.prototype.pop),bt=ge(Array.prototype.push),Ma=ge(Array.prototype.splice),tt=Array.isArray,Nt=ge(String.prototype.toLowerCase),Nn=ge(String.prototype.toString),Wo=ge(String.prototype.match),Dt=ge(String.prototype.replace),qo=ge(String.prototype.indexOf),Ba=ge(String.prototype.trim),Ua=ge(Number.prototype.toString),za=ge(Boolean.prototype.toString),Go=typeof BigInt>"u"?null:ge(BigInt.prototype.toString),Vo=typeof Symbol>"u"?null:ge(Symbol.prototype.toString),ye=ge(Object.prototype.hasOwnProperty),$t=ge(Object.prototype.toString),ke=ge(RegExp.prototype.test),rt=ja(TypeError);function ge(o){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,n=new Array(t>1?t-1:0),s=1;s<t;s++)n[s-1]=arguments[s];return Yn(o,e,n)}}function ja(o){return function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return Zn(o,t)}}function Q(o,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Nt;if(Ho&&Ho(o,null),!tt(e))return o;let n=e.length;for(;n--;){let s=e[n];if(typeof s=="string"){const a=t(s);a!==s&&(_a(e)||(e[n]=a),s=a)}o[s]=!0}return o}function Ha(o){for(let e=0;e<o.length;e++)ye(o,e)||(o[e]=null);return o}function De(o){const e=xt(null);for(const n of bs(o)){var t=Da(n,2);const s=t[0],a=t[1];ye(o,s)&&(tt(a)?e[s]=Ha(a):a&&typeof a=="object"&&a.constructor===Object?e[s]=De(a):e[s]=a)}return e}function Fa(o){switch(typeof o){case"string":return o;case"number":return Ua(o);case"boolean":return za(o);case"bigint":return Go?Go(o):"0";case"symbol":return Vo?Vo(o):"Symbol()";case"undefined":return $t(o);case"function":case"object":{if(o===null)return $t(o);const e=o,t=Ge(e,"toString");if(typeof t=="function"){const n=t(e);return typeof n=="string"?n:$t(n)}return $t(o)}default:return $t(o)}}function Ge(o,e){for(;o!==null;){const n=Na(o,e);if(n){if(n.get)return ge(n.get);if(typeof n.value=="function")return ge(n.value)}o=Oa(o)}function t(){return null}return t}function Wa(o){try{return ke(o,""),!0}catch{return!1}}const Ko=Se(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Pn=Se(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Mn=Se(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),qa=Se(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Bn=Se(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Ga=Se(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Yo=Se(["#text"]),Zo=Se(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Un=Se(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Xo=Se(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Qt=Se(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Va=Te(/{{[\w\W]*|^[\w\W]*}}/g),Ka=Te(/<%[\w\W]*|^[\w\W]*%>/g),Ya=Te(/\${[\w\W]*/g),Za=Te(/^data-[\-\w.\u00B7-\uFFFF]+$/),Xa=Te(/^aria-[\-\w]+$/),Jo=Te(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ja=Te(/^(?:\w+script|data):/i),Qa=Te(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),er=Te(/^html$/i),tr=Te(/^[a-z][.\w]*(-[.\w]+)+$/i),Qo=Te(/<[/\w!]/g),nr=Te(/<[/\w]/g),or=Te(/<\/no(script|embed|frames)/i),sr=Te(/\/>/i),qe={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},ar=function(){return typeof window>"u"?null:window},rr=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let n=null;const s="data-tt-policy-suffix";t&&t.hasAttribute(s)&&(n=t.getAttribute(s));const a="dompurify"+(n?"#"+n:"");try{return e.createPolicy(a,{createHTML(r){return r},createScriptURL(r){return r}})}catch{return console.warn("TrustedTypes policy "+a+" could not be created."),null}},es=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},et=function(e,t,n,s){return ye(e,t)&&tt(e[t])?Q(s.base?De(s.base):{},e[t],s.transform):n};function ys(){let o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:ar();const e=L=>ys(L);if(e.version="3.4.11",e.removed=[],!o||!o.document||o.document.nodeType!==qe.document||!o.Element)return e.isSupported=!1,e;let t=o.document;const n=t,s=n.currentScript;o.DocumentFragment;const a=o.HTMLTemplateElement,r=o.Node,i=o.Element,l=o.NodeFilter,d=o.NamedNodeMap;d===void 0&&(o.NamedNodeMap||o.MozNamedAttrMap),o.HTMLFormElement;const p=o.DOMParser,m=o.trustedTypes,g=i.prototype,f=Ge(g,"cloneNode"),O=Ge(g,"remove"),U=Ge(g,"nextSibling"),I=Ge(g,"childNodes"),P=Ge(g,"parentNode"),Z=Ge(g,"shadowRoot"),T=Ge(g,"attributes"),v=r&&r.prototype?Ge(r.prototype,"nodeType"):null,y=r&&r.prototype?Ge(r.prototype,"nodeName"):null;if(typeof a=="function"){const L=t.createElement("template");L.content&&L.content.ownerDocument&&(t=L.content.ownerDocument)}let E,C="",V,B=!1,$=0;const W=function(){if($>0)throw rt('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},ae=function(c){W(),$++;try{return E.createHTML(c)}finally{$--}},pe=function(c){W(),$++;try{return E.createScriptURL(c)}finally{$--}},Ie=function(){return B||(V=rr(m,s),B=!0),V},ue=t,x=ue.implementation,k=ue.createNodeIterator,F=ue.createDocumentFragment,z=ue.getElementsByTagName,b=n.importNode;let R=es();e.isSupported=typeof bs=="function"&&typeof P=="function"&&x&&x.createHTMLDocument!==void 0;const H=Va,K=Ka,j=Ya,h=Za,w=Xa,S=Ja,D=Qa,M=tr;let J=Jo,q=null;const ve=Q({},[...Ko,...Pn,...Mn,...Bn,...Yo]);let X=null;const Ee=Q({},[...Zo,...Un,...Xo,...Qt]);let oe=Object.seal(xt(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Ce=null,be=null;const $e=Object.seal(xt(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Tt=!0,It=!0,bo=!1,xo=!0,Je=!1,At=!0,st=!1,yn=!1,wn=null,vn=null,En=!1,ut=!1,qt=!1,Gt=!1,yo=!0,wo=!1;const vo="user-content-";let kn=!0,Sn=!1,ft={},Fe=null;const Tn=Q({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Eo=null;const ko=Q({},["audio","video","img","source","image","track"]);let In=null;const So=Q({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Vt="http://www.w3.org/1998/Math/MathML",Kt="http://www.w3.org/2000/svg",We="http://www.w3.org/1999/xhtml";let mt=We,An=!1,Ln=null;const Zs=Q({},[Vt,Kt,We],Nn),To=Se(["mi","mo","mn","ms","mtext"]);let Cn=Q({},To);const Io=Se(["annotation-xml"]);let Rn=Q({},Io);const Xs=Q({},["title","style","font","a","script"]);let Lt=null;const Js=["application/xhtml+xml","text/html"],Qs="text/html";let ie=null,gt=null;const ea=t.createElement("form"),Ao=function(c){return c instanceof RegExp||c instanceof Function},Dn=function(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(gt&&gt===c)return;(!c||typeof c!="object")&&(c={}),c=De(c),Lt=Js.indexOf(c.PARSER_MEDIA_TYPE)===-1?Qs:c.PARSER_MEDIA_TYPE,ie=Lt==="application/xhtml+xml"?Nn:Nt,q=et(c,"ALLOWED_TAGS",ve,{transform:ie}),X=et(c,"ALLOWED_ATTR",Ee,{transform:ie}),Ln=et(c,"ALLOWED_NAMESPACES",Zs,{transform:Nn}),In=et(c,"ADD_URI_SAFE_ATTR",So,{transform:ie,base:So}),Eo=et(c,"ADD_DATA_URI_TAGS",ko,{transform:ie,base:ko}),Fe=et(c,"FORBID_CONTENTS",Tn,{transform:ie}),Ce=et(c,"FORBID_TAGS",De({}),{transform:ie}),be=et(c,"FORBID_ATTR",De({}),{transform:ie}),ft=ye(c,"USE_PROFILES")?c.USE_PROFILES&&typeof c.USE_PROFILES=="object"?De(c.USE_PROFILES):c.USE_PROFILES:!1,Tt=c.ALLOW_ARIA_ATTR!==!1,It=c.ALLOW_DATA_ATTR!==!1,bo=c.ALLOW_UNKNOWN_PROTOCOLS||!1,xo=c.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Je=c.SAFE_FOR_TEMPLATES||!1,At=c.SAFE_FOR_XML!==!1,st=c.WHOLE_DOCUMENT||!1,ut=c.RETURN_DOM||!1,qt=c.RETURN_DOM_FRAGMENT||!1,Gt=c.RETURN_TRUSTED_TYPE||!1,En=c.FORCE_BODY||!1,yo=c.SANITIZE_DOM!==!1,wo=c.SANITIZE_NAMED_PROPS||!1,kn=c.KEEP_CONTENT!==!1,Sn=c.IN_PLACE||!1,J=Wa(c.ALLOWED_URI_REGEXP)?c.ALLOWED_URI_REGEXP:Jo,mt=typeof c.NAMESPACE=="string"?c.NAMESPACE:We,Cn=ye(c,"MATHML_TEXT_INTEGRATION_POINTS")&&c.MATHML_TEXT_INTEGRATION_POINTS&&typeof c.MATHML_TEXT_INTEGRATION_POINTS=="object"?De(c.MATHML_TEXT_INTEGRATION_POINTS):Q({},To),Rn=ye(c,"HTML_INTEGRATION_POINTS")&&c.HTML_INTEGRATION_POINTS&&typeof c.HTML_INTEGRATION_POINTS=="object"?De(c.HTML_INTEGRATION_POINTS):Q({},Io);const u=ye(c,"CUSTOM_ELEMENT_HANDLING")&&c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING=="object"?De(c.CUSTOM_ELEMENT_HANDLING):xt(null);if(oe=xt(null),ye(u,"tagNameCheck")&&Ao(u.tagNameCheck)&&(oe.tagNameCheck=u.tagNameCheck),ye(u,"attributeNameCheck")&&Ao(u.attributeNameCheck)&&(oe.attributeNameCheck=u.attributeNameCheck),ye(u,"allowCustomizedBuiltInElements")&&typeof u.allowCustomizedBuiltInElements=="boolean"&&(oe.allowCustomizedBuiltInElements=u.allowCustomizedBuiltInElements),Te(oe),Je&&(It=!1),qt&&(ut=!0),ft&&(q=Q({},Yo),X=xt(null),ft.html===!0&&(Q(q,Ko),Q(X,Zo)),ft.svg===!0&&(Q(q,Pn),Q(X,Un),Q(X,Qt)),ft.svgFilters===!0&&(Q(q,Mn),Q(X,Un),Q(X,Qt)),ft.mathMl===!0&&(Q(q,Bn),Q(X,Xo),Q(X,Qt))),$e.tagCheck=null,$e.attributeCheck=null,ye(c,"ADD_TAGS")&&(typeof c.ADD_TAGS=="function"?$e.tagCheck=c.ADD_TAGS:tt(c.ADD_TAGS)&&(q===ve&&(q=De(q)),Q(q,c.ADD_TAGS,ie))),ye(c,"ADD_ATTR")&&(typeof c.ADD_ATTR=="function"?$e.attributeCheck=c.ADD_ATTR:tt(c.ADD_ATTR)&&(X===Ee&&(X=De(X)),Q(X,c.ADD_ATTR,ie))),ye(c,"ADD_URI_SAFE_ATTR")&&tt(c.ADD_URI_SAFE_ATTR)&&Q(In,c.ADD_URI_SAFE_ATTR,ie),ye(c,"FORBID_CONTENTS")&&tt(c.FORBID_CONTENTS)&&(Fe===Tn&&(Fe=De(Fe)),Q(Fe,c.FORBID_CONTENTS,ie)),ye(c,"ADD_FORBID_CONTENTS")&&tt(c.ADD_FORBID_CONTENTS)&&(Fe===Tn&&(Fe=De(Fe)),Q(Fe,c.ADD_FORBID_CONTENTS,ie)),kn&&(q["#text"]=!0),st&&Q(q,["html","head","body"]),q.table&&(Q(q,["tbody"]),delete Ce.tbody),c.TRUSTED_TYPES_POLICY){if(typeof c.TRUSTED_TYPES_POLICY.createHTML!="function")throw rt('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof c.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw rt('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const A=E;E=c.TRUSTED_TYPES_POLICY;try{C=ae("")}catch(N){throw E=A,N}}else c.TRUSTED_TYPES_POLICY===null?(E=void 0,C=""):(E===void 0&&(E=Ie()),E&&typeof C=="string"&&(C=ae("")));Se&&Se(c),gt=c},Lo=Q({},[...Pn,...Mn,...qa]),Co=Q({},[...Bn,...Ga]),ta=function(c,u,A){return u.namespaceURI===We?c==="svg":u.namespaceURI===Vt?c==="svg"&&(A==="annotation-xml"||Cn[A]):!!Lo[c]},na=function(c,u,A){return u.namespaceURI===We?c==="math":u.namespaceURI===Kt?c==="math"&&Rn[A]:!!Co[c]},oa=function(c,u,A){return u.namespaceURI===Kt&&!Rn[A]||u.namespaceURI===Vt&&!Cn[A]?!1:!Co[c]&&(Xs[c]||!Lo[c])},sa=function(c){let u=P(c);(!u||!u.tagName)&&(u={namespaceURI:mt,tagName:"template"});const A=Nt(c.tagName),N=Nt(u.tagName);return Ln[c.namespaceURI]?c.namespaceURI===Kt?ta(A,u,N):c.namespaceURI===Vt?na(A,u,N):c.namespaceURI===We?oa(A,u,N):!!(Lt==="application/xhtml+xml"&&Ln[c.namespaceURI]):!1},Qe=function(c){bt(e.removed,{element:c});try{P(c).removeChild(c)}catch{if(O(c),!P(c))throw rt("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Ro=function(c){const u=I(c);if(u){const N=[];Rt(u,Y=>{bt(N,Y)}),Rt(N,Y=>{try{O(Y)}catch{}})}const A=T(c);if(A)for(let N=A.length-1;N>=0;--N){const Y=A[N],ee=Y&&Y.name;if(typeof ee=="string")try{c.removeAttribute(ee)}catch{}}},at=function(c,u){try{bt(e.removed,{attribute:u.getAttributeNode(c),from:u})}catch{bt(e.removed,{attribute:null,from:u})}if(u.removeAttribute(c),c==="is")if(ut||qt)try{Qe(u)}catch{}else try{u.setAttribute(c,"")}catch{}},aa=function(c){const u=T(c);if(u)for(let A=u.length-1;A>=0;--A){const N=u[A],Y=N&&N.name;if(!(typeof Y!="string"||X[ie(Y)]))try{c.removeAttribute(Y)}catch{}}},ra=function(c){const u=[c];for(;u.length>0;){const A=u.pop();(v?v(A):A.nodeType)===qe.element&&aa(A);const Y=I(A);if(Y)for(let ee=Y.length-1;ee>=0;--ee)u.push(Y[ee])}},Do=function(c){let u=null,A=null;if(En)c="<remove></remove>"+c;else{const ee=Wo(c,/^[\r\n\t ]+/);A=ee&&ee[0]}Lt==="application/xhtml+xml"&&mt===We&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");const N=E?ae(c):c;if(mt===We)try{u=new p().parseFromString(N,Lt)}catch{}if(!u||!u.documentElement){u=x.createDocument(mt,"template",null);try{u.documentElement.innerHTML=An?C:N}catch{}}const Y=u.body||u.documentElement;return c&&A&&Y.insertBefore(t.createTextNode(A),Y.childNodes[0]||null),mt===We?z.call(u,st?"html":"body")[0]:st?u.documentElement:Y},$o=function(c){return k.call(c.ownerDocument||c,c,l.SHOW_ELEMENT|l.SHOW_COMMENT|l.SHOW_TEXT|l.SHOW_PROCESSING_INSTRUCTION|l.SHOW_CDATA_SECTION,null)},Yt=function(c){return c=Dt(c,H," "),c=Dt(c,K," "),c=Dt(c,j," "),c},$n=function(c){var u;c.normalize();const A=k.call(c.ownerDocument||c,c,l.SHOW_TEXT|l.SHOW_COMMENT|l.SHOW_CDATA_SECTION|l.SHOW_PROCESSING_INSTRUCTION,null);let N=A.nextNode();for(;N;)N.data=Yt(N.data),N=A.nextNode();const Y=(u=c.querySelectorAll)===null||u===void 0?void 0:u.call(c,"template");Y&&Rt(Y,ee=>{ht(ee.content)&&$n(ee.content)})},Zt=function(c){const u=y?y(c):null;return typeof u!="string"||ie(u)!=="form"?!1:typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||c.attributes!==T(c)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function"||typeof c.hasChildNodes!="function"||c.nodeType!==v(c)||c.childNodes!==I(c)},ht=function(c){if(!v||typeof c!="object"||c===null)return!1;try{return v(c)===qe.documentFragment}catch{return!1}},Ct=function(c){if(!v||typeof c!="object"||c===null)return!1;try{return typeof v(c)=="number"}catch{return!1}};function Ye(L,c,u){L.length!==0&&Rt(L,A=>{A.call(e,c,u,gt)})}const ia=function(c,u){return!!(At&&c.hasChildNodes()&&!Ct(c.firstElementChild)&&ke(Qo,c.textContent)&&ke(Qo,c.innerHTML)||At&&c.namespaceURI===We&&u==="style"&&Ct(c.firstElementChild)||c.nodeType===qe.processingInstruction||At&&c.nodeType===qe.comment&&ke(nr,c.data))},la=function(c,u){if(!Ce[u]&&No(u)&&(oe.tagNameCheck instanceof RegExp&&ke(oe.tagNameCheck,u)||oe.tagNameCheck instanceof Function&&oe.tagNameCheck(u)))return!1;if(kn&&!Fe[u]){const A=P(c),N=I(c);if(N&&A){const Y=N.length;for(let ee=Y-1;ee>=0;--ee){const xe=Sn?N[ee]:f(N[ee],!0);A.insertBefore(xe,U(c))}}}return Qe(c),!0},_o=function(c){if(Ye(R.beforeSanitizeElements,c,null),Zt(c))return Qe(c),!0;const u=ie(y?y(c):c.nodeName);if(Ye(R.uponSanitizeElement,c,{tagName:u,allowedTags:q}),ia(c,u))return Qe(c),!0;if(Ce[u]||!($e.tagCheck instanceof Function&&$e.tagCheck(u))&&!q[u])return la(c,u);if((v?v(c):c.nodeType)===qe.element&&!sa(c)||(u==="noscript"||u==="noembed"||u==="noframes")&&ke(or,c.innerHTML))return Qe(c),!0;if(Je&&c.nodeType===qe.text){const N=Yt(c.textContent);c.textContent!==N&&(bt(e.removed,{element:c.cloneNode()}),c.textContent=N)}return Ye(R.afterSanitizeElements,c,null),!1},Oo=function(c,u,A){if(be[u]||yo&&(u==="id"||u==="name")&&(A in t||A in ea))return!1;const N=X[u]||$e.attributeCheck instanceof Function&&$e.attributeCheck(u,c);if(!(It&&ke(h,u))){if(!(Tt&&ke(w,u))){if(N){if(!In[u]){if(!ke(J,Dt(A,D,""))){if(!((u==="src"||u==="xlink:href"||u==="href")&&c!=="script"&&qo(A,"data:")===0&&Eo[c])){if(!(bo&&!ke(S,Dt(A,D,"")))){if(A)return!1}}}}}else if(!(No(c)&&(oe.tagNameCheck instanceof RegExp&&ke(oe.tagNameCheck,c)||oe.tagNameCheck instanceof Function&&oe.tagNameCheck(c))&&(oe.attributeNameCheck instanceof RegExp&&ke(oe.attributeNameCheck,u)||oe.attributeNameCheck instanceof Function&&oe.attributeNameCheck(u,c))||u==="is"&&oe.allowCustomizedBuiltInElements&&(oe.tagNameCheck instanceof RegExp&&ke(oe.tagNameCheck,A)||oe.tagNameCheck instanceof Function&&oe.tagNameCheck(A))))return!1}}return!0},ca=Q({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),No=function(c){return!ca[Nt(c)]&&ke(M,c)},da=function(c,u,A,N){if(E&&typeof m=="object"&&typeof m.getAttributeType=="function"&&!A)switch(m.getAttributeType(c,u)){case"TrustedHTML":return ae(N);case"TrustedScriptURL":return pe(N)}return N},pa=function(c,u,A,N){try{A?c.setAttributeNS(A,u,N):c.setAttribute(u,N),Zt(c)?Qe(c):Fo(e.removed)}catch{at(u,c)}},Po=function(c){Ye(R.beforeSanitizeAttributes,c,null);const u=c.attributes;if(!u||Zt(c))return;const A={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:X,forceKeepAttr:void 0};let N=u.length;const Y=ie(c.nodeName);for(;N--;){const ee=u[N],xe=ee.name,fe=ee.namespaceURI,Oe=ee.value,ze=ie(xe),On=Oe;let Re=xe==="value"?On:Ba(On);if(A.attrName=ze,A.attrValue=Re,A.keepAttr=!0,A.forceKeepAttr=void 0,Ye(R.uponSanitizeAttribute,c,A),Re=A.attrValue,wo&&(ze==="id"||ze==="name")&&qo(Re,vo)!==0&&(at(xe,c),Re=vo+Re),At&&ke(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Re)){at(xe,c);continue}if(ze==="attributename"&&Wo(Re,"href")){at(xe,c);continue}if(!A.forceKeepAttr){if(!A.keepAttr){at(xe,c);continue}if(!xo&&ke(sr,Re)){at(xe,c);continue}if(Je&&(Re=Yt(Re)),!Oo(Y,ze,Re)){at(xe,c);continue}Re=da(Y,ze,fe,Re),Re!==On&&pa(c,xe,fe,Re)}}Ye(R.afterSanitizeAttributes,c,null)},Xt=function(c){let u=null;const A=$o(c);for(Ye(R.beforeSanitizeShadowDOM,c,null);u=A.nextNode();)if(Ye(R.uponSanitizeShadowNode,u,null),_o(u),Po(u),ht(u.content)&&Xt(u.content),(v?v(u):u.nodeType)===qe.element){const Y=Z(u);ht(Y)&&(_n(Y),Xt(Y))}Ye(R.afterSanitizeShadowDOM,c,null)},_n=function(c){const u=[{node:c,shadow:null}];for(;u.length>0;){const A=u.pop();if(A.shadow){Xt(A.shadow);continue}const N=A.node,ee=(v?v(N):N.nodeType)===qe.element,xe=I(N);if(xe)for(let fe=xe.length-1;fe>=0;--fe)u.push({node:xe[fe],shadow:null});if(ee){const fe=y?y(N):null;if(typeof fe=="string"&&ie(fe)==="template"){const Oe=N.content;ht(Oe)&&u.push({node:Oe,shadow:null})}}if(ee){const fe=Z(N);ht(fe)&&u.push({node:null,shadow:fe},{node:fe,shadow:null})}}};return e.sanitize=function(L){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},u=null,A=null,N=null,Y=null;if(An=!L,An&&(L="<!-->"),typeof L!="string"&&!Ct(L)&&(L=Fa(L),typeof L!="string"))throw rt("dirty is not a string, aborting");if(!e.isSupported)return L;yn?(q=wn,X=vn):Dn(c),(R.uponSanitizeElement.length>0||R.uponSanitizeAttribute.length>0)&&(q=De(q)),R.uponSanitizeAttribute.length>0&&(X=De(X)),e.removed=[];const ee=Sn&&typeof L!="string"&&Ct(L);if(ee){const Oe=y?y(L):L.nodeName;if(typeof Oe=="string"){const ze=ie(Oe);if(!q[ze]||Ce[ze])throw rt("root node is forbidden and cannot be sanitized in-place")}if(Zt(L))throw rt("root node is clobbered and cannot be sanitized in-place");try{_n(L)}catch(ze){throw Ro(L),ze}}else if(Ct(L))u=Do("<!---->"),A=u.ownerDocument.importNode(L,!0),A.nodeType===qe.element&&A.nodeName==="BODY"||A.nodeName==="HTML"?u=A:u.appendChild(A),_n(A);else{if(!ut&&!Je&&!st&&L.indexOf("<")===-1)return E&&Gt?ae(L):L;if(u=Do(L),!u)return ut?null:Gt?C:""}u&&En&&Qe(u.firstChild);const xe=$o(ee?L:u);try{for(;N=xe.nextNode();)_o(N),Po(N),ht(N.content)&&Xt(N.content)}catch(Oe){throw ee&&Ro(L),Oe}if(ee)return Rt(e.removed,Oe=>{Oe.element&&ra(Oe.element)}),Je&&$n(L),L;if(ut){if(Je&&$n(u),qt)for(Y=F.call(u.ownerDocument);u.firstChild;)Y.appendChild(u.firstChild);else Y=u;return(X.shadowroot||X.shadowrootmode)&&(Y=b.call(n,Y,!0)),Y}let fe=st?u.outerHTML:u.innerHTML;return st&&q["!doctype"]&&u.ownerDocument&&u.ownerDocument.doctype&&u.ownerDocument.doctype.name&&ke(er,u.ownerDocument.doctype.name)&&(fe="<!DOCTYPE "+u.ownerDocument.doctype.name+`>
`+fe),Je&&(fe=Yt(fe)),E&&Gt?ae(fe):fe},e.setConfig=function(){let L=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Dn(L),yn=!0,wn=q,vn=X},e.clearConfig=function(){gt=null,yn=!1,wn=null,vn=null,E=V,C=""},e.isValidAttribute=function(L,c,u){gt||Dn({});const A=ie(L),N=ie(c);return Oo(A,N,u)},e.addHook=function(L,c){typeof c=="function"&&ye(R,L)&&bt(R[L],c)},e.removeHook=function(L,c){if(ye(R,L)){if(c!==void 0){const u=Pa(R[L],c);return u===-1?void 0:Ma(R[L],u,1)[0]}return Fo(R[L])}},e.removeHooks=function(L){ye(R,L)&&(R[L]=[])},e.removeAllHooks=function(){R=es()},e}var Mt=ys();function ao(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let dt=ao();function ws(o){dt=o}const vs=/[&<>"']/,ir=new RegExp(vs.source,"g"),Es=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,lr=new RegExp(Es.source,"g"),cr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ts=o=>cr[o];function _e(o,e){if(e){if(vs.test(o))return o.replace(ir,ts)}else if(Es.test(o))return o.replace(lr,ts);return o}const dr=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function pr(o){return o.replace(dr,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const ur=/(^|[^\[])\^/g;function se(o,e){let t=typeof o=="string"?o:o.source;e=e||"";const n={replace:(s,a)=>{let r=typeof a=="string"?a:a.source;return r=r.replace(ur,"$1"),t=t.replace(s,r),n},getRegex:()=>new RegExp(t,e)};return n}function ns(o){try{o=encodeURI(o).replace(/%25/g,"%")}catch{return null}return o}const Bt={exec:()=>null};function os(o,e){const t=o.replace(/\|/g,(a,r,i)=>{let l=!1,d=r;for(;--d>=0&&i[d]==="\\";)l=!l;return l?"|":" |"}),n=t.split(/ \|/);let s=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;s<n.length;s++)n[s]=n[s].trim().replace(/\\\|/g,"|");return n}function en(o,e,t){const n=o.length;if(n===0)return"";let s=0;for(;s<n&&o.charAt(n-s-1)===e;)s++;return o.slice(0,n-s)}function fr(o,e){if(o.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<o.length;n++)if(o[n]==="\\")n++;else if(o[n]===e[0])t++;else if(o[n]===e[1]&&(t--,t<0))return n;return-1}function ss(o,e,t,n){const s=e.href,a=e.title?_e(e.title):null,r=o[1].replace(/\\([\[\]])/g,"$1");if(o[0].charAt(0)!=="!"){n.state.inLink=!0;const i={type:"link",raw:t,href:s,title:a,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,i}return{type:"image",raw:t,href:s,title:a,text:_e(r)}}function mr(o,e){const t=o.match(/^(\s+)(?:```)/);if(t===null)return e;const n=t[1];return e.split(`
`).map(s=>{const a=s.match(/^\s+/);if(a===null)return s;const[r]=a;return r.length>=n.length?s.slice(n.length):s}).join(`
`)}class pn{constructor(e){re(this,"options");re(this,"rules");re(this,"lexer");this.options=e||dt}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const n=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:en(n,`
...
Please report this to https://github.com/markedjs/marked.`,e){const s="<p>An error occurred:</p><pre>"+_e(n.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(n);throw n}};const lt=new jr;function te(o,e){return lt.parse(o,e)}te.options=te.setOptions=function(o){return lt.setOptions(o),te.defaults=lt.defaults,ws(te.defaults),te};te.getDefaults=ao;te.defaults=dt;te.use=function(...o){return lt.use(...o),te.defaults=lt.defaults,ws(te.defaults),te};te.walkTokens=function(o,e){return lt.walkTokens(o,e)};te.parseInline=lt.parseInline;te.Parser=Ke;te.parser=Ke.parse;te.Renderer=fn;te.TextRenderer=uo;te.Lexer=Ve;te.lexer=Ve.lex;te.Tokenizer=pn;te.Hooks=Ut;te.parse=te;te.options;te.setOptions;te.use;te.walkTokens;te.parseInline;Ke.parse;Ve.lex;const vt=new te.Renderer,Hr=vt.link.bind(vt);vt.link=(o,e,t)=>Hr(o,e,t).replace("<a ",'<a target="_blank" rel="noopener noreferrer" class="text-teal-400 hover:underline" ');vt.heading=(o,e)=>{const t=o.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,"");return`<h${e} id="${t}">${o}</h${e}>`};vt.table=(o,e)=>`<div class="overflow-x-auto my-4 max-w-full"><table class="w-full">${o}${e}</table></div>`;te.setOptions({renderer:vt,gfm:!0,breaks:!0});function Ds(){try{return parseInt(localStorage.getItem("secops-sanitize-count")||"0",10)}catch{return 0}}function $s(){try{const o=Ds();localStorage.setItem("secops-sanitize-count",(o+1).toString())}catch{}}function Et(o){$s();const e=te.parse(o);Mt.addHook("uponSanitizeElement",n=>{if(n instanceof Element){const s=n.tagName.toLowerCase();if(s==="video"||s==="audio"||s==="iframe"||s==="source"||s==="img"){const a=n.getAttribute("src");if(a){const r=a.trim().toLowerCase();r.startsWith("data:")||r.startsWith("blob:")||r.startsWith("attachment:")||r.startsWith("/")||r.startsWith("./")||r.startsWith("../")||(n.setAttribute("src","#"),console.warn("SECURITY BLOCK: Prevented connection to remote source URL:",a))}s==="iframe"&&n.setAttribute("sandbox","allow-scripts")}}});const t=Mt.sanitize(e,{ALLOWED_TAGS:["h1","h2","h3","h4","h5","h6","p","br","hr","a","span","ul","ol","li","strong","em","code","pre","blockquote","table","thead","tbody","tr","th","td","div","img","input","video","audio","iframe","source"],ALLOWED_ATTR:["href","target","rel","class","id","align","src","alt","type","checked","disabled","controls","sandbox","width","height"]});return Mt.removeHook("uponSanitizeElement"),t}function sn(o){return o.replace(/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F\u200B-\u200D\uFEFF\u202A-\u202E]/g,"")}function _(o){return o.replace(/[&<>"']/g,e=>{switch(e){case"&":return"&amp;";case"<":return"&lt;";case">":return"&gt;";case'"':return"&quot;";case"'":return"&#039;";default:return e}})}function Fr(o){if($s(),typeof o!="object"||o===null)throw new Error("Invalid backup structure: Root must be an object.");const{slug:e,title:t,content:n,updatedAt:s,tags:a}=o;if(typeof e!="string"||!/^[a-z0-9-_]+$/.test(e))throw new Error("Invalid slug format: Slugs must contain only lowercase alphanumeric characters, hyphens, and underscores.");const r=sn(e);if(typeof t!="string"||t.trim().length===0||t.length>100)throw new Error("Invalid title format: Must be a non-empty string under 100 characters.");const i=sn(t);if(typeof n!="string"||n.length>5e4)throw new Error("Invalid content format: Must be a string under 50,000 characters.");if(typeof s!="number"||isNaN(s))throw new Error("Invalid updated timestamp format.");if(!Array.isArray(a))throw new Error("Tags must be an array of strings.");const l=a.map(d=>{if(typeof d!="string")throw new Error("Tags must be strings.");return sn(Mt.sanitize(d)).slice(0,30)});return{slug:r,title:Mt.sanitize(i),content:n,updatedAt:s,tags:l,isSystem:!!o.isSystem}}async function Le(o){const e=new TextEncoder,t=e.encode("secops-intel-salt-2026"),n=await window.crypto.subtle.importKey("raw",e.encode(o),{name:"PBKDF2"},!1,["deriveKey"]);return window.crypto.subtle.deriveKey({name:"PBKDF2",salt:t,iterations:1e5,hash:"SHA-256"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}async function ot(o,e){const t=new TextEncoder,n=window.crypto.getRandomValues(new Uint8Array(12)),s=await window.crypto.subtle.encrypt({name:"AES-GCM",iv:n},e,t.encode(o)),a=Array.from(n).map(d=>d.toString(16).padStart(2,"0")).join(""),r=new Uint8Array(s);let i="";for(let d=0;d<r.byteLength;d++)i+=String.fromCharCode(r[d]);const l=btoa(i);return`${a}:${l}`}async function me(o,e){const t=o.split(":");if(t.length!==2)throw new Error("Invalid cipher format");const[n,s]=t,a=new Uint8Array(n.match(/.{1,2}/g).map(d=>parseInt(d,16))),r=atob(s),i=new Uint8Array(r.length);for(let d=0;d<r.length;d++)i[d]=r.charCodeAt(d);const l=await window.crypto.subtle.decrypt({name:"AES-GCM",iv:a},e,i);return new TextDecoder().decode(l)}async function Ze(o){const e=`${o.slug}|${o.title}|${o.content}|${o.updatedAt}|${o.tags.join(",")}|secops-integrity-salt-2026`,t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(a=>a.toString(16).padStart(2,"0")).join("")}let ne="home",Xe=!1,Ne=!1,je="",Ot="",ce=[],Pt=null,_s=navigator.onLine?"SECURE_LINK":"OFFLINE_CACHE",wt=localStorage.getItem("secops-wiki-theme")||"dark",nt=localStorage.getItem("secops-wiki-mask-encrypted")==="true",nn=localStorage.getItem("secops-wiki-split-screen")!=="false",an={},de=null;async function le(o,e){const t={id:`${Date.now()}-${Math.random().toString(36).substring(2,11)}`,timestamp:Date.now(),event:o,details:e};await Sa(t)}async function He(o){const e=await ba(o);if(!e)return null;if(e.isEncryptedAtRest&&e.encryptedData){if(!de)return{slug:e.slug,title:"[DATABASE LOCKED]",content:"Master passphrase required to unlock this database record.",tags:[],isSystem:e.isSystem,isEncrypted:!1,updatedAt:e.updatedAt};try{const t=await me(e.encryptedData,de),n=JSON.parse(t);return{slug:e.slug,title:n.title,content:n.content,tags:n.tags,isSystem:e.isSystem,isEncrypted:n.isEncrypted,signature:n.signature,updatedAt:n.updatedAt}}catch(t){return console.error("Failed to decrypt page at rest:",t),null}}return e}async function Me(o){if(localStorage.getItem("secops-wiki-db-encrypted")==="true"&&de){const t={title:o.title,content:o.content,tags:o.tags,isEncrypted:o.isEncrypted,signature:o.signature,updatedAt:o.updatedAt},n=await ot(JSON.stringify(t),de),s={slug:o.slug,title:"[REDACTED AT REST]",content:"[REDACTED AT REST]",tags:[],isSystem:o.isSystem,isEncryptedAtRest:!0,encryptedData:n,updatedAt:o.updatedAt};await dn(s)}else await dn(o);localStorage.setItem("secops-wiki-last-update",Date.now().toString())}async function fo(){const o=await Ht(),e=[];for(const t of o){const n=await He(t.slug);n&&e.push(n)}return e}async function mo(){try{const o=await gs();an={},o.forEach(e=>{an[e.tag]=e.color})}catch{an={}}}function Wr(o){const e=an[o]||"slate";let t="bg-slate-950/20 text-slate-400 border-slate-900/30";return e==="emerald"?t="bg-emerald-950/20 text-emerald-400 border-emerald-900/30":e==="blue"?t="bg-blue-950/20 text-blue-400 border-blue-900/30":e==="red"?t="bg-red-950/20 text-red-400 border-red-900/30":e==="amber"&&(t="bg-amber-950/20 text-amber-400 border-amber-900/30"),`
  ...
  `,document.body.appendChild(o);const e=document.getElementById("pwa-update-reload-btn");e&&e.addEventListener("click",()=>{window.location.reload()})}function oi(){"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/wiki/sw.js").then(o=>{console.log("ServiceWorker registered successfully with scope: ",o.scope),o.waiting&&cs(),o.addEventListener("updatefound",()=>{const e=o.installing;e&&e.addEventListener("statechange",()=>{e.state==="installed"&&navigator.serviceWorker.controller&&cs()})})}).catch(o=>{console.error("ServiceWorker registration failed: ",o)})})}function mn(){_s=navigator.onLine?"SECURE_LINK":"OFFLINE_CACHE";const o=document.getElementById("system-status-indicator"),e=document.getElementById("system-status-label");o&&e&&(navigator.onLine?(o.className="w-2 h-2 rounded-full bg-emerald-400 glow-text-emerald pulse-indicator",e.innerText="SECURE_LINK",e.className="text-xs text-emerald-400 font-mono tracking-wider"):(o.className="w-2 h-2 rounded-full bg-amber-500 pulse-indicator",e.innerText="OFFLINE_CACHE",e.className="text-xs text-amber-500 font-mono tracking-wider"))}async function Ae(){ce=await fo(),await ki(),to=localStorage.getItem("secops-wiki-last-update")||"0"}async function no(){const o=await Ht(),e=Date.now();let t=!1;for(const n of o)n.expiresAt&&e>n.expiresAt&&(await us(n.slug),await le("SELF_DESTRUCT_EXPIRY",`Intel Entry "${n.title}" (slug: ${n.slug}) has self-destructed due to lease expiration.`),t=!0,ne===n.slug&&(ne="home",window.location.hash="#/page/home"));t&&(await Ae(),await we(),pt.postMessage("refresh"))}async function gn(){await no();const o=window.location.hash||"#/page/home";Xe=!1,Ne=!1;let e="";if(o.startsWith("#/page/")){const n=o.replace("#/page/","").split("#");ne=n[0],n.length>1&&(e=n[1])}else o.startsWith("#/edit/")?(ne=o.replace("#/edit/",""),Xe=!0):o==="#/new"?(Xe=!0,Ne=!0,ne=""):o==="#/system"?ne="system":o==="#/graph"?ne="graph":o.startsWith("#/import-p2p")?ne="import-p2p":ne="home";!Xe&&ne&&ne!=="system"&&ne!=="graph"&&Gr(ne),await we(),e&&setTimeout(()=>{const t=document.getElementById(e);t&&t.scrollIntoView({behavior:"smooth"})},50)}function qn(o){const e=o.filter(a=>a.isSystem),t=o.filter(a=>!a.isSystem&&a.isEncrypted),n=o.filter(a=>!a.isSystem&&!a.isEncrypted);let s="";return e.length>0&&(s+=`
      <div class="mb-4">
    ...
    `),s}function Gn(o){const e=ne===o.slug&&!Xe,t=o.isEncrypted&&!G&&nt,n=t?"[REDACTED CORE]":o.title,s=t?"javascript:void(0)":`#/page/${o.slug}`,a=t?`onclick="alert('SECURITY WARNING: Document is locked. Enter passphrase to decrypt cores first.');"`:"";let r="";if(je.trim().length>0){const i=o.isEncrypted&&!G,l=kt.find(d=>d.slug===o.slug)||o;if(!i&&l.content){const d=l.content.toLowerCase().indexOf(je.toLowerCase());if(d!==-1){const p=Math.max(0,d-20),m=Math.min(l.content.length,d+je.length+30);let g=l.content.substring(p,m);p>0&&(g="..."+g),m<l.content.length&&(g=g+"...");const f=_(g),O=new RegExp(`(${je.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")})`,"gi");r=`<div class="text-[10px] text-slate-500 font-mono mt-1 pl-4 break-all whitespace-normal leading-normal">${f.replace(O,'<span class="bg-teal-950 text-teal-350 px-0.5 rounded font-bold">$1</span>')}</div>`}}}return`
  ...
  `}async function we(){var I,P,Z;await Ae();let o=ce;je.trim().length>0&&(o=o.map(T=>({page:T,score:zs(kt.find(v=>v.slug===T.slug)||T,je)})).filter(T=>T.score>0).sort((T,v)=>v.score-T.score).map(T=>T.page)),Ot&&(o=o.filter(T=>T.tags.includes(Ot)));const e=Array.from(new Set(ce.flatMap(T=>T.tags)));Hs.innerHTML=`
        ...
        ${e.length>0?`
          <div class="px-4 py-2 border-b border-slate-800/80 flex flex-wrap gap-1 max-h-24 overflow-y-auto shrink-0 select-none">
            ...
            ${e.map(T=>{const v=Qr(T);return`
                <button class="tag-badge px-1.5 py-0.5 text-[9px] rounded-full font-mono transition ${Ot===T?"bg-teal-500 text-slate-950 font-bold shadow-[0_0_8px_rgba(20,184,166,0.3)]":`${v.className} hover:opacity-85`}" data-tag="${_(T)}">#${_(T.toUpperCase())}</button>
              `}).join("")}
          </div>
        `:""}
  ...
  `;const t=document.getElementById("wiki-search-input");t&&t.addEventListener("input",T=>{je=T.target.value;const v=kt.filter(E=>E.title.toLowerCase().includes(je.toLowerCase())||E.content.toLowerCase().includes(je.toLowerCase())||E.tags.some(C=>C.toLowerCase().includes(je.toLowerCase()))),y=document.getElementById("pages-list");y.innerHTML=qn(v),v.length===0&&(y.innerHTML='<div class="text-center py-6 text-xs text-slate-650 font-mono">No entries found</div>')});const n=document.getElementById("pwa-install-btn");n&&n.addEventListener("click",async()=>{if(Pt){Pt.prompt();const{outcome:T}=await Pt.userChoice;T==="accepted"&&console.log("User accepted the PWA install prompt"),Pt=null,n.classList.add("hidden")}});const s=document.getElementById("system-panic-btn");s&&s.addEventListener("click",async()=>{if(confirm("CRITICAL SYSTEM COMPROMISE PROTOCOL: Purge entire local database, clear all service worker caches, unregister service workers, and force self-destruct reload immediately?")){if(indexedDB.deleteDatabase("secops-wiki-db"),"caches"in window){const T=await caches.keys();await Promise.all(T.map(v=>caches.delete(v)))}if("serviceWorker"in navigator){const T=await navigator.serviceWorker.getRegistrations();await Promise.all(T.map(v=>v.unregister()))}localStorage.clear(),sessionStorage.clear(),G=null,window.history.replaceState(null,"","about:blank"),window.location.replace("about:blank")}});const a=document.getElementById("sidebar-toggle-btn"),r=document.getElementById("sidebar-close-btn"),i=document.getElementById("sidebar-backdrop"),l=()=>{const T=document.getElementById("sidebar"),v=document.getElementById("sidebar-backdrop");T&&v&&(T.classList.add("-translate-x-full"),v.classList.add("hidden"))},d=()=>{const T=document.getElementById("sidebar"),v=document.getElementById("sidebar-backdrop");T&&v&&(T.classList.remove("-translate-x-full"),v.classList.remove("hidden"))};a&&a.addEventListener("click",d),r&&r.addEventListener("click",l),i&&i.addEventListener("click",l),document.querySelectorAll("#sidebar a").forEach(T=>{T.addEventListener("click",()=>{window.innerWidth<768&&l()})});const m=document.getElementById("theme-toggle-btn");m&&m.addEventListener("click",Us);const g=[12,13,14,15,16,18,20];let f=parseInt(localStorage.getItem("secops-wiki-font-size-idx")||"2",10);const O=()=>{document.documentElement.style.setProperty("--wiki-font-size",g[f]+"px"),localStorage.setItem("secops-wiki-font-size-idx",f.toString())};O(),(I=document.getElementById("font-size-increase-btn"))==null||I.addEventListener("click",()=>{f<g.length-1&&(f++,O())}),(P=document.getElementById("font-size-decrease-btn"))==null||P.addEventListener("click",()=>{f>0&&(f--,O())}),(Z=document.getElementById("font-size-reset-btn"))==null||Z.addEventListener("click",()=>{f=2,O()}),document.querySelectorAll(".tag-badge").forEach(T=>{T.addEventListener("click",async v=>{Ot=v.currentTarget.getAttribute("data-tag")||"",await we()})});const U=document.getElementById("tag-tree-container");U&&(U.addEventListener("click",T=>{const v=T.target.closest(".tree-folder-header");if(v){const y=v.nextElementSibling,E=v.querySelector(".tree-folder-icon");if(y){const C=y.classList.toggle("hidden");E&&(E.style.transform=C?"rotate(0deg)":"rotate(90deg)")}}}),U.addEventListener("keydown",T=>{var V,B;const v=document.activeElement;if(!v||!U.contains(v))return;const E=Array.from(U.querySelectorAll(".tree-folder-header, .tree-folder-children a")).filter($=>{let W=$.parentElement;for(;W&&W!==U;){if(W.classList.contains("tree-folder-children")&&W.classList.contains("hidden"))return!1;W=W.parentElement}return!0}),C=E.indexOf(v);if(C!==-1){if(T.key==="ArrowDown"){T.preventDefault();const $=(C+1)%E.length;(V=E[$])==null||V.focus()}else if(T.key==="ArrowUp"){T.preventDefault();const $=(C-1+E.length)%E.length;(B=E[$])==null||B.focus()}else if(T.key==="Enter")T.preventDefault(),v.click();else if(T.key==="ArrowRight"){if(T.preventDefault(),v.classList.contains("tree-folder-header")){const $=v.nextElementSibling,W=v.querySelector(".tree-folder-icon");$&&$.classList.contains("hidden")&&($.classList.remove("hidden"),W&&(W.style.transform="rotate(90deg)"))}}else if(T.key==="ArrowLeft"&&(T.preventDefault(),v.classList.contains("tree-folder-header"))){const $=v.nextElementSibling,W=v.querySelector(".tree-folder-icon");$&&!$.classList.contains("hidden")&&($.classList.add("hidden"),W&&(W.style.transform="rotate(0deg)"))}}})),await si()}async function si(){const o=document.getElementById("main-content");if(ne==="graph"){await vi(o);return}if(ne==="system"){zt(o);return}if(ne==="import-p2p"){await _i(o);return}if(Xe){await Ws(o);return}await hn(o)}async function hn(o){const e=await He(ne);if(!e){o.innerHTML=`
    ...
    `;return}const t=await Si(e.slug);let n=e.content,s=!1;if(e.isEncrypted)if(G)try{n=await me(e.content,G)}catch{s=!0}else s=!0;if(s){const x=rs();let k="";if(x&&(k=`<p class="text-red-500 text-xs font-mono font-bold mt-2 animate-pulse uppercase">SECURITY LOCKOUT: Too many failures. Locked out for ${Math.ceil((eo()-Date.now())/1e3)}s.</p>`),o.innerHTML=`
      <div class="max-w-md mx-auto my-20 p-6 glass-panel border border-teal-900/30 rounded-xl text-center glow-border select-none">
        ...
        <div id="decrypt-lockout-timer">${k}</div>
      </div>
    `,x){const z=setInterval(async()=>{const b=Math.ceil((eo()-Date.now())/1e3),R=document.getElementById("decrypt-lockout-timer");b<=0?(clearInterval(z),await hn(o)):R&&(R.innerHTML=`<p class="text-red-500 text-xs font-mono font-bold mt-2 animate-pulse uppercase">SECURITY LOCKOUT: Too many failures. Locked out for ${b}s.</p>`)},1e3)}setTimeout(()=>{const z=document.getElementById("decrypt-password-input");z==null||z.focus()},50),document.getElementById("decrypt-doc-form").addEventListener("submit",async z=>{if(z.preventDefault(),rs()){alert("Security Lockout active.");return}const b=document.getElementById("decrypt-password-input").value;try{const R=await Le(b);await me(e.content,R),Zr(),G=R,await we()}catch{Yr(),alert("Security Alert: Authentication failed. Invalid security passphrase."),await hn(o)}});return}const a=n.split(/\s+/).filter(x=>x.length>0).length,r=Math.max(1,Math.round(a/200)),i=Et(n),l=new Date(e.updatedAt).toLocaleString(),d=document.createElement("div");d.innerHTML=i,qr(d);const p=d.innerHTML,m=Jr(p,je),g=d.querySelectorAll("h1, h2, h3");let f="";g.length>0&&(f=`
      <div class="hidden lg:block w-60 shrink-0 self-start sticky top-8">
        <div class="glass-panel border border-slate-800/80 rounded-xl p-4">
          ...
          <nav class="space-y-2 text-xs font-mono max-h-[350px] overflow-y-auto pr-1">
            ${Array.from(g).map(x=>{const k=x.textContent||"",F=x.id||k.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,""),z=x.tagName.toLowerCase(),b=z==="h1"?"pl-0 font-semibold":z==="h2"?"pl-3 border-l border-slate-800":"pl-6 border-l border-slate-800";return`
                <a href="#/page/${e.slug}#${F}" class="block text-slate-500 hover:text-teal-400 transition truncate ${b}" title="${_(k)}">
                  ${_(k)}
                </a>
              `}).join("")}
          </nav>
    ...
    `);const O=n.match(/^(\s*[-*] )\[ \]/gm)||[],U=n.match(/^(\s*[-*] )\[[xX]\]/gm)||[],I=O.length+U.length;let P="";if(I>0){const x=U.length,k=Math.round(x/I*100),F=10,z=Math.round(x/I*F),b=F-z;P=`
      <div class="glass-panel border border-slate-800/80 p-3 rounded-lg flex items-center justify-between mb-6 text-[10px] sm:text-xs font-mono select-none">
        <div class="flex items-center gap-2 sm:gap-3">
          ...
          <span class="text-teal-400 font-bold">${k}%</span>
        </div>
    ...
    `}let Z="";try{const x=JSON.parse(sessionStorage.getItem("secops-wiki-breadcrumbs")||"[]");x.length>1&&(Z=`
        <div class="flex items-center gap-1.5 text-[10px] font-mono text-slate-500 mb-3 select-none overflow-x-auto whitespace-nowrap pb-1">
          ...
          ${x.map((k,F)=>{const z=Vr(k),R=k===e.slug?"text-teal-400 font-bold":"text-slate-450 hover:text-slate-350 transition",H=F<x.length-1?'<span class="text-slate-850">/</span>':"";return`
              <a href="#/page/${k}" class="${R}">${_(z)}</a>
              ${H}
            `}).join("")}
        </div>
  ...
  `;o.innerHTML=`
    <div class="flex flex-col lg:flex-row gap-4 lg:gap-8 items-start">
      <!-- Main Content Area -->
      <div class="flex-1 min-w-0 glass-panel border rounded-xl p-5 md:p-6 shadow-xl ${E}">
            ...
            <div class="mt-4 space-y-3 divide-y divide-slate-800/60 max-h-48 overflow-y-auto pr-1">
              ${t.map((x,k)=>`
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-3 first:pt-0">
                  <div class="min-w-0">
                    <p class="text-xs font-mono text-slate-300 break-words">REV_${t.length-k} // ${_(x.title)}</p>
                    <p class="text-[10px] font-mono text-slate-500">${new Date(x.updatedAt).toLocaleString()}</p>
                  </div>
                  <button class="restore-rev-btn px-2.5 py-1 bg-slate-900 border border-slate-800 hover:border-slate-700 text-teal-400 hover:text-teal-300 font-mono text-[10px] rounded transition uppercase shrink-0 self-start sm:self-auto" data-rev-id="${_(x.id)}">
                    ROLLBACK
                  </button>
                  <button class="view-rev-diff-btn px-2.5 py-1 bg-slate-900 border border-slate-800 hover:border-slate-700 text-blue-400 hover:text-blue-300 font-mono text-[10px] rounded transition uppercase shrink-0 self-start sm:self-auto" data-rev-id="${_(x.id)}">
                    Diff
                  </button>
                </div>
              `).join("")}
    ...
    `:""}
  `;const B=document.getElementById("pin-page-btn"),$=document.getElementById("pin-page-text");if(B&&$){let x=JSON.parse(localStorage.getItem("pinned_docs")||"[]");x.includes(e.slug)&&(B.classList.add("text-amber-400"),$.innerText="Unpin"),B.addEventListener("click",()=>{x=JSON.parse(localStorage.getItem("pinned_docs")||"[]"),x.includes(e.slug)?(x=x.filter(k=>k!==e.slug),B.classList.remove("text-amber-400"),$.innerText="Pin"):(x.push(e.slug),B.classList.add("text-amber-400"),$.innerText="Unpin"),localStorage.setItem("pinned_docs",JSON.stringify(x)),we()})}const W=document.getElementById("page-export-dropdown-btn"),ae=document.getElementById("page-export-menu");if(W&&ae){W.addEventListener("click",j=>{j.stopPropagation(),ae.classList.toggle("hidden")}),document.addEventListener("click",()=>{ae.classList.add("hidden")});const x=document.getElementById("clone-page-btn");x&&x.addEventListener("click",async()=>{const j=e.slug+"-copy",h={...e,slug:j,title:"Copy of "+e.title,id:crypto.randomUUID(),createdAt:Date.now(),updatedAt:Date.now()};await Me(h),window.location.hash=`#/edit/${j}`});const k=document.querySelectorAll(".toc-link");if(k.length>0){const j=new IntersectionObserver(h=>{h.forEach(w=>{w.isIntersecting&&k.forEach(S=>{S.classList.remove("text-teal-400","font-bold"),S.getAttribute("data-id")===w.target.id&&S.classList.add("text-teal-400","font-bold")})})},{rootMargin:"0px 0px -80% 0px"});document.querySelectorAll("h1, h2, h3").forEach(h=>j.observe(h))}const F=document.getElementById("read-progress");if(F){const j=()=>{const h=document.documentElement.scrollHeight-document.documentElement.clientHeight;if(h>0){const w=window.scrollY/h*100;F.style.width=w+"%"}};window.addEventListener("scroll",j)}document.getElementById("export-single-md").addEventListener("click",async()=>{let j=e.content;if(e.isEncrypted&&G)try{j=await me(e.content,G)}catch{}const h=`---
title: ${e.title}
slug: ${e.slug}
tags: ${e.tags.join(", ")}
...
`,w=new Blob([h+j],{type:"text/markdown;charset=utf-8;"}),S=URL.createObjectURL(w),D=document.createElement("a");D.href=S,D.download=`${e.slug}.md`,document.body.appendChild(D),D.click(),document.body.removeChild(D),URL.revokeObjectURL(S)}),document.getElementById("export-single-html").addEventListener("click",async()=>{let j=e.content;if(e.isEncrypted&&G)try{j=await me(e.content,G)}catch{}const h=Et(j),w=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
    ...
    ${h}
        ...
        <div class="border-t border-slate-800 mt-8 pt-6">
          ...
          <div class="flex flex-wrap gap-2">
            ${x.map(k=>`
              <a href="#/page/${k.slug}" class="px-3 py-1.5 bg-slate-900/60 border border-slate-800 hover:border-teal-500/50 hover:text-teal-400 text-slate-400 font-mono text-xs rounded-lg transition flex items-center gap-1.5">
                <span class="text-[9px]">${k.isEncrypted?"🔒":"⊙"}</span>
                ${_(k.title)}
              </a>
            `).join("")}
          </div>
        </div>
      `)}}async function Ws(o){let e="",t="",n="",s=[],a=!1,r=!1,i="UNCLASSIFIED",l=0;if(!Ne){const h=await He(ne);if(h&&(e=h.title,t=h.slug,n=h.content,s=[...h.tags],a=!!h.isSystem,r=!!h.isEncrypted,i=h.classification||"UNCLASSIFIED",h.expiresAt&&h.updatedAt&&(l=Math.round((h.expiresAt-h.updatedAt)/6e4)),h.isEncrypted))if(G)try{n=await me(h.content,G)}catch{n="ERROR: Decryption key mismatch. Please go back and re-decrypt."}else n="ERROR: This page is encrypted. Decrypt it in the reader view first."}const d=`secops-wiki-draft-${Ne?"new":ne}`;let p="";const m=localStorage.getItem(d);if(m)try{const h=JSON.parse(m);e=h.title||e,n=h.content||n,Array.isArray(h.tags)?s=h.tags:typeof h.tags=="string"&&(s=h.tags.split(",").map(w=>w.trim()).filter(w=>w.length>0)),p=`
      ...
      <form id="edit-page-form" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-slate-800">
          ...
          <div class="flex gap-3 justify-end self-end sm:self-auto">
            <a href="${Ne?"#/page/home":`#/page/${ne}`}" id="cancel-edit-btn" class="px-4 py-2 bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 font-mono text-xs uppercase rounded transition hover:text-white">
              Cancel
            </a>
...
`).length;w.innerText=`Words: ${S} | Chars: ${D} | Lines: ${M}`}if(h.trim().length===0){O.innerHTML='<span class="text-slate-600 font-mono text-xs">No input content.</span>';return}O.innerHTML=Et(h)};function E(h){const w=h.trim().split(`
`);if(w.length<2)return h;const S=w.map(q=>{let ve=q.trim();return ve.startsWith("|")&&(ve=ve.slice(1)),ve.endsWith("|")&&(ve=ve.slice(0,-1)),ve.split("|").map(X=>X.trim())}),D=Math.max(...S.map(q=>q.length));if(D===0)return h;const M=Array(D).fill(0);for(let q=0;q<S.length;q++){const ve=q===1&&S[q].every(X=>/^:-*-*:?$/.test(X)||/^-+$/.test(X));for(let X=0;X<D;X++){const Ee=S[q][X]||"";!ve&&Ee.length>M[X]&&(M[X]=Ee.length)}}for(let q=0;q<D;q++)M[q]=Math.max(M[q],3);return S.map((q,ve)=>{const X=ve===1&&q.every(oe=>/^:-*-*:?$/.test(oe)||/^-+$/.test(oe));return`| ${Array(D).fill("").map((oe,Ce)=>{const be=q[Ce]||"";if(X){const $e=be.startsWith(":"),Tt=be.endsWith(":"),It=M[Ce]-($e?1:0)-(Tt?1:0);return($e?":":"")+"-".repeat(Math.max(1,It))+(Tt?":":"")}else return be.padEnd(M[Ce]," ")}).join(" | ")} |`}).join(`
...
- [ ] ${M||"Task description"}
`;break}f.value=D.substring(0,w)+J+D.substring(S),f.focus(),f.selectionStart=w+J.length,f.selectionEnd=w+J.length,y()};o.querySelectorAll(".format-btn").forEach(h=>{h.addEventListener("click",w=>{const S=w.currentTarget.getAttribute("data-format")||"";V(S)})}),f.addEventListener("keyup",h=>{const w=f.value,S=f.selectionStart;if(w.substring(S-2,S)==="[[")rn=!0,ln=S,Qn="",bi(f);else if(rn){if(h.key==="Escape"||h.key==="ArrowUp"||h.key==="ArrowDown"||h.key==="Enter")return;const M=w.substring(ln,S);M.includes(`
`)||S<ln?cn():(Qn=M,Gs(f))}}),f.addEventListener("keydown",h=>{if(rn){const w=document.getElementById("autocomplete-popup");if(!w)return;const S=w.querySelectorAll(".editor-autocomplete-item");let D=Array.from(S).findIndex(M=>M.classList.contains("active"));h.key==="ArrowDown"?(h.preventDefault(),S.length>0&&(D>=0&&S[D].classList.remove("active","bg-teal-950/20","text-teal-400"),D=(D+1)%S.length,S[D].classList.add("active","bg-teal-950/20","text-teal-400"),S[D].scrollIntoView({block:"nearest"}))):h.key==="ArrowUp"?(h.preventDefault(),S.length>0&&(D>=0&&S[D].classList.remove("active","bg-teal-950/20","text-teal-400"),D=(D-1+S.length)%S.length,S[D].classList.add("active","bg-teal-950/20","text-teal-400"),S[D].scrollIntoView({block:"nearest"}))):h.key==="Enter"?(h.preventDefault(),D>=0?S[D].click():S.length>0&&S[0].click()):h.key==="Escape"&&(h.preventDefault(),cn())}}),f.addEventListener("input",()=>{y(),z()}),f.addEventListener("keydown",h=>{if(h.ctrlKey&&(h.key==="s"||h.key==="S")){h.preventDefault();const w=document.getElementById("edit-page-form");w&&w.requestSubmit();return}if(h.key==="Tab"){h.preventDefault();const w=f.selectionStart,S=f.selectionEnd;f.value=f.value.substring(0,w)+"  "+f.value.substring(S),f.selectionStart=f.selectionEnd=w+2,y();return}if(h.ctrlKey&&(h.key==="b"||h.key==="B")){h.preventDefault();const w=f.selectionStart,S=f.selectionEnd,D=f.value.substring(w,S),M=`**${D||"bold"}**`;f.value=f.value.substring(0,w)+M+f.value.substring(S),f.selectionStart=w+2,f.selectionEnd=w+2+(D||"bold").length,y();return}if(h.ctrlKey&&(h.key==="i"||h.key==="I")){h.preventDefault();const w=f.selectionStart,S=f.selectionEnd,D=f.value.substring(w,S),M=`*${D||"italic"}*`;f.value=f.value.substring(0,w)+M+f.value.substring(S),f.selectionStart=w+1,f.selectionEnd=w+1+(D||"italic").length,y();return}}),y();const B=document.getElementById("tag-pills-container"),$=document.getElementById("tag-pill-input"),W=document.getElementById("tag-pill-dropdown"),ae=Array.from(new Set(ce.flatMap(h=>h.tags)));function pe(){if(!B||!$)return;B.querySelectorAll(".tag-badge-pill").forEach(S=>S.remove()),s.forEach(S=>{const D=document.createElement("span");D.className="tag-badge-pill flex items-center gap-1 text-[10px] font-mono bg-teal-950/40 text-teal-400 px-2 py-1 rounded border border-teal-900/30 select-none",D.innerHTML=`
        #${_(S)}
        <button type="button" class="tag-remove-btn hover:text-red-400 font-bold transition focus:outline-none" data-tag="${_(S)}">×</button>
      `,B.insertBefore(D,$)}),B.querySelectorAll(".tag-remove-btn").forEach(S=>{S.addEventListener("click",D=>{const M=D.currentTarget.getAttribute("data-tag");M&&(s=s.filter(J=>J!==M),pe(),z())})})}function Ie(){if(!W||!$)return;const h=$.value.trim().toLowerCase(),w=ae.filter(D=>D.includes(h)&&!s.includes(D));if(w.length===0){W.classList.add("hidden");return}W.innerHTML=w.map(D=>`
      <div class="tag-dropdown-item px-3 py-2 cursor-pointer hover:bg-slate-900 hover:text-white text-slate-350 transition" data-tag="${_(D)}">
        #${_(D)}
      </div>
    `).join(""),W.classList.remove("hidden"),W.querySelectorAll(".tag-dropdown-item").forEach(D=>{D.addEventListener("click",M=>{const J=M.currentTarget.getAttribute("data-tag");J&&!s.includes(J)&&(s.push(J),pe(),z()),$.value="",W.classList.add("hidden"),$.focus()})})}$&&($.addEventListener("keydown",h=>{if(h.key==="Enter"||h.key===","){h.preventDefault();const w=$.value.trim().toLowerCase().replace(/[^a-z0-9-_]/g,"");w&&!s.includes(w)&&(s.push(w),pe(),z()),$.value="",W&&W.classList.add("hidden")}else h.key==="Backspace"&&$.value===""&&(s.pop(),pe(),z())}),$.addEventListener("input",Ie),$.addEventListener("focus",Ie)),pe();const ue=document.getElementById("editor-layout-grid"),x=document.getElementById("live-preview-container"),k=document.getElementById("toggle-split-btn");function F(){!ue||!x||!k||(nn?(ue.classList.remove("md:grid-cols-1"),ue.classList.add("md:grid-cols-2"),x.classList.remove("md:hidden"),x.classList.add("md:block"),k.textContent="Full Width",k.classList.remove("text-slate-450"),k.classList.add("text-teal-400")):(ue.classList.remove("md:grid-cols-2"),ue.classList.add("md:grid-cols-1"),x.classList.remove("md:block"),x.classList.add("md:hidden"),k.textContent="Split Screen",k.classList.remove("text-teal-400"),k.classList.add("text-slate-450")))}k&&k.addEventListener("click",()=>{nn=!nn,localStorage.setItem("secops-wiki-split-screen",nn.toString()),F()}),F();const z=()=>{var S;const h=(S=document.getElementById("edit-title"))==null?void 0:S.value,w=f.value;(h||w||s.length>0)&&localStorage.setItem(d,JSON.stringify({title:h,content:w,tags:s,updatedAt:Date.now()}))},b=setInterval(z,5e3),R=()=>{clearInterval(b),window.removeEventListener("hashchange",R)};window.addEventListener("hashchange",R);const H=()=>{clearInterval(b),window.removeEventListener("hashchange",R),localStorage.removeItem(d),cn()};U.addEventListener("click",H),I&&I.addEventListener("click",()=>{var h;H(),(h=document.getElementById("draft-restore-banner"))==null||h.remove(),Ws(o)});const K=h=>{W&&!W.contains(h.target)&&h.target!==$&&W.classList.add("hidden")};document.addEventListener("click",K);const j=()=>{document.removeEventListener("click",K),window.removeEventListener("hashchange",j)};window.addEventListener("hashchange",j),g.addEventListener("submit",async h=>{h.preventDefault();const w=document.getElementById("edit-title").value.trim(),S=Ne?document.getElementById("edit-slug").value.trim().toLowerCase():t,D=f.value,M=document.getElementById("edit-encrypt").checked,J=document.getElementById("edit-classification").value,q=document.getElementById("edit-expiry"),ve=q?parseInt(q.value,10):0;if(Ne&&!/^[a-z0-9-_]+$/.test(S)){alert("Security Alert: Slug contains illegal characters. Use alphanumeric, hyphens, and underscores only.");return}const X=s.map(be=>sn(be.trim()).toLowerCase()).filter(be=>be.length>0),Ee=await He(S);Ee&&await ho({id:`${Ee.slug}-${Date.now()}`,slug:Ee.slug,title:Ee.title,content:Ee.content,updatedAt:Ee.updatedAt,isEncrypted:Ee.isEncrypted,tags:Ee.tags,classification:Ee.classification,signature:Ee.signature});let oe=D;if(M){if(!G){const be=prompt("Enter a security passphrase to encrypt this document (min 8 chars, mixed case, numbers, symbols):");if(!be){alert("Encryption Aborted: A security passphrase is required to save an encrypted document.");return}const $e=Ms(be);if(!$e.valid){alert(`SECURITY ERROR: Passphrase too weak.

${$e.message}`);return}G=await Le(be)}try{oe=await ot(D,G)}catch(be){alert(`Encryption failure: ${be.message}`);return}}const Ce={slug:S,title:w,content:oe,updatedAt:Date.now(),tags:X,isSystem:a,isEncrypted:M,classification:J};ve>0&&(Ce.expiresAt=Ce.updatedAt+ve*60*1e3),Ce.signature=await Ze(Ce);try{await Me(Ce),H(),pt.postMessage("refresh"),window.location.hash=`#/page/${S}`}catch(be){alert(`Database transaction error: ${be.message}`)}})}function ai(o,e){let t=o.replace(/\.md$/i,"").replace(/[-_]+/g," ");t=t.split(" ").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" ");let n=o.replace(/\.md$/i,"").toLowerCase().replace(/[^a-z0-9-_]+/g,"-"),s=e,a=["imported"];if(e.startsWith("---")){const r=e.indexOf("---",3);if(r!==-1){const i=e.substring(3,r);s=e.substring(r+3).trim(),i.split(`
...
<body>
  ...
  <main>
    ...
    <div>
      ${o.map(s=>`
        <div class="page-card">
          <a class="page-title" href="${s.slug}.html">${_(s.title)}</a>
          <div class="metadata">
            SLUG: ${s.slug} | TAGS: #${s.tags.map(a=>_(a)).join(", #")} | UPDATED: ${new Date(s.updatedAt).toLocaleString()}
          </div>
        </div>
      `).join("")}
    </div>
...
<head>
  <meta charset="UTF-8">
  <title>${_(s.title)} - SecOps Static Wiki</title>
  <style>
    body {
      background-color: #0b0f19;
      color: #cbd5e1;
...
<body>
  ...
  <main>
    ...
    <div class="metadata">
      ...
      Tags: ${s.tags.map(l=>`<span class="badge">#${_(l)}</span>`).join("")}
    </div>
...
`&&!n?(e.push(t),t=""):t+=d}if(t&&e.push(t),e.length<2)return[];const s=l=>{const d=[];let p="",m=!1;for(let g=0;g<l.length;g++){const f=l[g];f==='"'?m=!m:f===","&&!m?(d.push(a(p)),p=""):p+=f}return d.push(a(p)),d},a=l=>(l=l.trim(),l.startsWith('"')&&l.endsWith('"')&&(l=l.substring(1,l.length-1)),l.replace(/""/g,'"')),r=s(e[0]).map(l=>l.toLowerCase()),i=[];for(let l=1;l<e.length;l++){if(!e[l].trim())continue;const d=s(e[l]),p={};r.forEach((m,g)=>{p[m]=d[g]||""}),i.push(p)}return i}function di(o){var i;const e=o.title||"Untitled CSV Import",t=o.content||"";let n=o.slug||e.toLowerCase().replace(/[^a-z0-9-_]+/g,"-");n=n.toLowerCase().replace(/[^a-z0-9-_]+/g,"-"),n||(n=`imported-${Date.now()}`);const a=(o.tags||"imported, csv").split(/[,;|]+/).map(l=>l.trim().toLowerCase()).filter(l=>l.length>0),r=o.updatedat?parseInt(o.updatedat):Date.now();return{slug:n,title:e,content:t,updatedAt:isNaN(r)?Date.now():r,tags:a,isSystem:!1,isEncrypted:((i=o.encrypted)==null?void 0:i.toLowerCase())==="true"}}function pi(o,e){const t=o.split(`
`),n=e.split(`
...
`);n.innerHTML=`
      <div class="glass-panel border border-teal-900/30 rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col glow-border shadow-2xl">
        <div class="p-4 border-b border-slate-800 flex items-center justify-between shrink-0">
          <h3 class="text-sm font-bold font-mono text-white uppercase tracking-wider">Conflict Detected: ${_(o.slug)}</h3>
        ...
        <div class="p-4 overflow-y-auto space-y-4 flex-1">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-slate-950/50 border border-slate-850 p-3 rounded-lg space-y-2">
              ...
              <p class="text-xs font-mono text-white"><span class="text-slate-500">TITLE:</span> ${_(o.title)}</p>
    ...
    `,document.getElementById("diff-opt-skip").addEventListener("click",()=>{n.classList.add("hidden"),t("SKIP")}),document.getElementById("diff-opt-rename").addEventListener("click",()=>{n.classList.add("hidden"),t("MERGE_RENAME")}),document.getElementById("diff-opt-overwrite").addEventListener("click",()=>{n.classList.add("hidden"),t("OVERWRITE")}),document.getElementById("diff-opt-archive").addEventListener("click",()=>{n.classList.add("hidden"),t("REVISION")})})}async function Vn(o,e){const t=Fr(o),n=await He(t.slug);if(n){let s=e;if(e==="ASK"&&(s=await ui(n,t)),s==="SKIP")return!1;if(s==="REVISION")await ho({id:`${n.slug}-${Date.now()}`,slug:n.slug,title:n.title,content:n.content,updatedAt:n.updatedAt,isEncrypted:n.isEncrypted,tags:n.tags,classification:n.classification,signature:n.signature}),t.signature=await Ze(t),await Me(t);else if(s==="OVERWRITE")t.signature=await Ze(t),await Me(t);else if(s==="MERGE_RENAME"){let a=`${t.slug}-imported`,r=await He(a),i=1;for(;r;)a=`${t.slug}-imported-${i}`,r=await He(a),i++;t.slug=a,t.title=`${t.title} (Imported)`,t.signature=await Ze(t),await Me(t)}}else t.signature=await Ze(t),await Me(t);return!0}async function ds(o){var m,g;if(!o||o.length===0)return;const e=((m=document.getElementById("import-conflict-resolution"))==null?void 0:m.value)||"REVISION";let t=0,n=0,s=0,a=0,r=0,i=0,l=0,d=0,p=0;for(let f=0;f<o.length;f++){const O=o[f],U=(g=O.name.split(".").pop())==null?void 0:g.toLowerCase();U==="md"?await new Promise(I=>{const P=new FileReader;P.onload=async Z=>{var T;try{const v=(T=Z.target)==null?void 0:T.result,y=ai(O.name,v);await Vn(y,e)?t++:a++}catch{l++}I()},P.readAsText(O)}):U==="csv"?await new Promise(I=>{const P=new FileReader;P.onload=async Z=>{var T;try{const v=(T=Z.target)==null?void 0:T.result,y=ci(v);for(const E of y)try{const C=di(E);await Vn(C,e)?n++:r++}catch{d++}}catch{d++}I()},P.readAsText(O)}):U==="json"&&await new Promise(I=>{const P=new FileReader;P.onload=async Z=>{var T;try{const v=JSON.parse((T=Z.target)==null?void 0:T.result);let y=v;if(v&&v.encrypted===!0&&v.payload){const C=prompt("Secure Backup: Enter password to decrypt database backup file:");if(C===null){p++,I();return}try{const V=await Le(C),B=await me(v.payload,V);y=JSON.parse(B)}catch{alert("Backup Decryption Alert: Authentication failed. Invalid backup passphrase."),p++,I();return}}else v&&v.encrypted===!1&&v.payload&&(y=v.payload);const E=Array.isArray(y)?y:[y];for(const C of E)try{!C.slug&&C.title&&(C.slug=C.title.toLowerCase().replace(/[^a-z0-9-_]+/g,"-")),C.slug||(C.slug=`imported-item-${Date.now()}-${Math.floor(Math.random()*1e3)}`),C.title||(C.title=C.slug.replace(/[-_]+/g," ")),typeof C.tags=="string"&&(C.tags=C.tags.split(",").map(B=>B.trim()).filter(B=>B.length>0)),Array.isArray(C.tags)||(C.tags=[]),C.classification||(C.classification="UNCLASSIFIED"),typeof C.updatedAt!="number"&&(C.updatedAt=Date.now()),await Vn(C,e)?s++:i++}catch{p++}}catch{p++}I()},P.readAsText(O)})}alert(`INGESTION COMPLETED (Conflict resolution: ${e.toUpperCase()}):
...
- Failed: ${p}`),pt.postMessage("refresh"),await Ae(),await we()}async function fi(){const o=document.getElementById("tag-color-palette-manager");if(!o)return;const e=Array.from(new Set(ce.flatMap(r=>r.tags))),t=await gs();if(e.length===0){o.innerHTML='<p class="text-xs font-mono text-slate-500">No active document tags registered.</p>';return}let n='<div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">';for(const r of e){const i=t.find(d=>d.tag===r),l=i?i.color:"slate";n+=`
      <div class="flex items-center justify-between p-2 bg-slate-950/40 border border-slate-800 rounded">
        ...
        <div class="flex gap-2 items-center">
          ...
          <select class="tag-color-select bg-slate-900 border border-slate-850 text-xs font-mono text-slate-300 rounded px-2 py-1 focus:outline-none focus:border-teal-500 cursor-pointer" data-tag="${_(r)}"> border border-slate-850 text-xs font-mono text-slate-300 rounded px-2 py-1 focus:outline-none focus:border-teal-500 cursor-pointer" data-tag="${_(r)}">
    ...
    `}n+="</div>",o.innerHTML=n,o.querySelectorAll(".rename-tag-btn").forEach(r=>{r.addEventListener("click",async i=>{const l=i.currentTarget.getAttribute("data-tag"),d=prompt(`Rename tag "#${l}" to:`);if(d&&d.trim()&&d!==l){const p=d.trim().toLowerCase().replace(/[^a-z0-9-]/g,"");if(p.length>0){for(const m of ce)m.tags.includes(l)&&(m.tags=m.tags.map(g=>g===l?p:g),await Me(m));le("TAG_RENAME",`Renamed tag ${l} to ${p}`),await we()}}})}),o.querySelectorAll(".tag-color-select").forEach(r=>{r.addEventListener("change",async i=>{const l=i.currentTarget.getAttribute("data-tag"),d=i.currentTarget.value;await va({tag:l,color:d}),await mo(),await we()})})}function zt(o){const e=Array.from(new Set(ce.flatMap(y=>y.tags)));o.innerHTML=`
    <div class="space-y-6">
      <!-- Title -->
  ...
  `;const t=document.getElementById("system-export-btn"),n=document.getElementById("system-export-zip-btn"),s=document.getElementById("system-export-web-zip-btn"),a=document.getElementById("system-export-csv-btn"),r=document.getElementById("system-export-html-btn"),i=document.getElementById("system-unified-import-file"),l=document.getElementById("system-reset-btn"),d=document.getElementById("total-articles-telemetry"),p=document.getElementById("db-health-diagnostics"),m=document.getElementById("system-drop-zone");d.textContent=ce.length.toString(),p&&Ei(p),fi();const g=()=>{const y=document.getElementById("export-tag-filter"),E=(y==null?void 0:y.value)||"ALL";return E==="ALL"?ce:ce.filter(C=>C.tags.includes(E))};t.addEventListener("click",async()=>{const y=g(),E=await ka(),C={pages:y,attachments:E},V=prompt("Secure Backup: Enter a password to encrypt this database backup file (leave blank for plain JSON):");let B,$=`secops-wiki-backup-${Date.now()}.json`;if(V)try{const pe=await Le(V),Ie=JSON.stringify(C,null,2),x={encrypted:!0,schemaVersion:4,payload:await ot(Ie,pe)};B=new Blob([JSON.stringify(x,null,2)],{type:"application/json"}),$=`secops-wiki-encrypted-backup-${Date.now()}.json`}catch(pe){alert(`Backup encryption failed: ${pe.message}`);return}else{if(V===null)return;const pe={encrypted:!1,schemaVersion:4,payload:C};B=new Blob([JSON.stringify(pe,null,2)],{type:"application/json"})}const W=URL.createObjectURL(B),ae=document.createElement("a");ae.href=W,ae.download=$,document.body.appendChild(ae),ae.click(),document.body.removeChild(ae),URL.revokeObjectURL(W)}),n.addEventListener("click",async()=>{const y=g(),E=[];for(const $ of y){let W=$.content;if($.isEncrypted&&G)try{W=await me($.content,G)}catch{}const ae=`---
title: ${$.title}
slug: ${$.slug}
tags: ${$.tags.join(", ")}
...
`;E.push({name:`${$.slug}.md`,content:ae+W})}const C=js(E),V=URL.createObjectURL(C),B=document.createElement("a");B.href=V,B.download=`secops-wiki-backup-${Date.now()}.zip`,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(V)}),s.addEventListener("click",()=>{const y=g(),E=li(y),C=URL.createObjectURL(E),V=document.createElement("a");V.href=C,V.download=`secops-wiki-web-${Date.now()}.zip`,document.body.appendChild(V),V.click(),document.body.removeChild(V),URL.revokeObjectURL(C)}),a.addEventListener("click",()=>{const y=g(),E=ri(y),C=new Blob([E],{type:"text/csv;charset=utf-8;"}),V=URL.createObjectURL(C),B=document.createElement("a");B.href=V,B.download=`secops-wiki-report-${Date.now()}.csv`,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(V)}),r.addEventListener("click",()=>{const y=g(),E=ii(y),C=new Blob([E],{type:"text/html;charset=utf-8;"}),V=URL.createObjectURL(C),B=document.createElement("a");B.href=V,B.download=`secops-wiki-book-${Date.now()}.html`,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(V)}),i&&i.addEventListener("change",async y=>{const E=y.target.files;E&&E.length>0&&await ds(E)}),["dragenter","dragover","dragleave","drop"].forEach(y=>{m.addEventListener(y,E=>{E.preventDefault(),E.stopPropagation()},!1)}),["dragenter","dragover"].forEach(y=>{m.addEventListener(y,()=>{m.classList.add("border-teal-500","bg-teal-950/10")},!1)}),["dragleave","drop"].forEach(y=>{m.addEventListener(y,()=>{m.classList.remove("border-teal-500","bg-teal-950/10")},!1)}),m.addEventListener("drop",async y=>{const E=y.dataTransfer,C=E==null?void 0:E.files;C&&C.length>0&&await ds(C)}),m.addEventListener("click",()=>{i&&i.click()}),l.addEventListener("click",async()=>{const y=prompt('CRITICAL SECURITY WARNING: Type "WIPE" to verify you want to delete ALL wiki pages and custom documents:');if(y==="WIPE")try{if(await ms(),"caches"in window)try{const E=await caches.keys();for(const C of E)await caches.delete(C)}catch(E){console.warn("Failed to clear caches: ",E)}await so(),await mo(),alert("Database successfully wiped, caches invalidated, and seeded with standard operating defaults."),localStorage.setItem("secops-wiki-last-update",Date.now().toString()),pt.postMessage("refresh"),await Ae(),window.location.hash="#/page/home"}catch(E){alert(`Reset failed: ${E.message}`)}else y!==null&&alert("Sanitization aborted. Confirmation keyword mismatch.")});const f=document.getElementById("system-session-timeout-select");f&&f.addEventListener("change",()=>{localStorage.setItem("secops-wiki-session-timeout",f.value),go()});const O=document.getElementById("system-cache-bust-btn");O&&O.addEventListener("click",async()=>{if(confirm("CRITICAL DIAGNOSTICS: Purge cached service worker registrations and static asset cache buckets? This triggers an immediate application reload.")){if("serviceWorker"in navigator){const y=await navigator.serviceWorker.getRegistrations();for(const E of y)await E.unregister()}if("caches"in window){const y=await caches.keys();for(const E of y)await caches.delete(E)}alert("CACHE WIPE COMPLETED. Reloading system..."),window.location.reload()}});const U=document.getElementById("system-mask-encrypted-checkbox");U&&U.addEventListener("change",()=>{nt=U.checked,localStorage.setItem("secops-wiki-mask-encrypted",nt.toString()),Ae().then(()=>{we()})});const I=document.getElementById("system-db-encrypted-checkbox");I&&I.addEventListener("change",async()=>{if(I.checked){const E=prompt("Enter a new Master Passphrase to secure the database (min 8 chars, mixed case, numbers, symbols):");if(!E){I.checked=!1;return}const C=Ms(E);if(!C.valid){alert(`SECURITY ERROR: Passphrase too weak.

${C.message}`),I.checked=!1;return}try{de=await Le(E),localStorage.setItem("secops-wiki-db-encrypted","true");const B=await Ht();for(const $ of B)$.isEncryptedAtRest||await Me($);alert("Database encryption successfully activated. All records are encrypted at rest."),await le("DB_ENCRYPTION_ENABLED","Activated database encryption-at-rest."),await Ae(),zt(o)}catch(V){alert(`Activation failed: ${V.message}`),I.checked=!1}}else{const E=prompt("Enter the current Master Passphrase to confirm decryption:");if(!E){I.checked=!0;return}try{const C=await Le(E);if(!await St(C)){alert("Verification Failed: Incorrect master passphrase."),I.checked=!0;return}const B=await fo();localStorage.setItem("secops-wiki-db-encrypted","false"),localStorage.removeItem("secops-wiki-webauthn-gate"),localStorage.removeItem("secops-wiki-webauthn-payload"),localStorage.removeItem("secops-wiki-webauthn-salt"),de=null;for(const $ of B){const W={slug:$.slug,title:$.title,content:$.content,tags:$.tags,isSystem:$.isSystem,isEncrypted:$.isEncrypted,signature:$.signature,updatedAt:$.updatedAt};await dn(W)}alert("Database encryption-at-rest successfully deactivated."),await le("DB_ENCRYPTION_DISABLED","Deactivated database encryption-at-rest."),await Ae(),zt(o)}catch(C){alert(`Deactivation failed: ${C.message}`),I.checked=!0}}});const P=document.getElementById("system-webauthn-register-btn");P&&P.addEventListener("click",async()=>{localStorage.getItem("secops-wiki-webauthn-gate")==="true"?confirm("Are you sure you want to deregister biometric credentials?")&&(localStorage.removeItem("secops-wiki-webauthn-gate"),localStorage.removeItem("secops-wiki-webauthn-payload"),localStorage.removeItem("secops-wiki-webauthn-salt"),alert("Biometric unlock credentials removed."),await le("WEBAUTHN_DEREGISTER","Removed biometric credentials."),zt(o)):await Ci()}),Kn();const Z=document.getElementById("system-prune-audit-btn");Z&&Z.addEventListener("click",async()=>{confirm("Audit Log Pruning: Confirm deletion of security logs older than 30 days?")&&(await hs(30),await le("AUDIT_LOG_PRUNED","Manually pruned audit logs older than 30 days."),await Kn(),alert("Audit logs successfully pruned."))});const T=document.getElementById("system-wipe-audit-btn");T&&T.addEventListener("click",async()=>{confirm("CRITICAL ACTION: Are you sure you want to purge the security audit log registers?")&&(await Ia(),await le("AUDIT_LOG_CLEARED","Security audit log register cleared."),await Kn())}),oo();const v=document.getElementById("system-wipe-all-drafts-btn");v&&v.addEventListener("click",()=>{if(confirm("CRITICAL WARN: Purge all unsaved document draft fragments in local storage?")){const y=[];for(let E=0;E<localStorage.length;E++){const C=localStorage.key(E)||"";C.startsWith("secops-wiki-draft-")&&y.push(C)}y.forEach(E=>localStorage.removeItem(E)),oo()}})}function oo(){const o=document.getElementById("system-drafts-recovery-list");if(!o)return;const e=[];for(let n=0;n<localStorage.length;n++){const s=localStorage.key(n)||"";s.startsWith("secops-wiki-draft-")&&e.push(s)}const t=e.map(n=>{try{const s=localStorage.getItem(n)||"",a=JSON.parse(s),r=n.substring(18);return{key:n,slug:r,title:a.title||"(Untitled)",updatedAt:a.updatedAt||Date.now(),size:s.length}}catch{return null}}).filter(n=>n!==null);if(t.length===0){o.innerHTML='<p class="text-xs font-mono text-slate-500">No unsaved drafts found in local storage.</p>';return}o.innerHTML=t.map(n=>`
  ...
  `,document.body.appendChild(o);const e=document.getElementById("command-palette-input");e.addEventListener("input",()=>{Pe=0,bn()}),e.addEventListener("keydown",gi),o.addEventListener("click",t=>{t.target===o&&jt()})}function bn(){const o=document.getElementById("command-palette-input"),e=document.getElementById("command-palette-results");if(!e)return;const t=o?o.value.trim().toLowerCase():"",n=[{title:"CREATE NEW PAGE",subtitle:"Open the editor to establish a new document",icon:"➕",action:()=>{window.location.hash="#/new"}},{title:"TOGGLE THEME",subtitle:`Switch visual style (currently ${wt})`,icon:"🌓",action:()=>{Us()}},{title:"SYSTEM ADMIN",subtitle:"Access operations console and db diagnostics",icon:"⚙️",action:()=>{window.location.hash="#/system"}},{title:"TACTICAL MAP VIEW",subtitle:"Display interactive node relationship map",icon:"🗺️",action:()=>{window.location.hash="#/graph"}},{title:"PANIC PURGE PROTOCOL",subtitle:"Emergency self-destruct - wipes all data",icon:"🚨",action:()=>{const p=document.getElementById("system-panic-btn");p&&p.click()}}];let s="",a=0;const r=n.filter(p=>p.title.toLowerCase().includes(t)||p.subtitle.toLowerCase().includes(t));let i=[];t?i=ce.map(p=>({page:p,score:zs(kt.find(m=>m.slug===p.slug)||p,t)})).filter(p=>p.score>0).sort((p,m)=>m.score-p.score):i=ce.slice(0,5).map(p=>({page:p,score:0}));const l=r.length+i.length;Pe>=l?Pe=0:Pe<0&&(Pe=l-1),r.forEach(p=>{s+=`
    ...
    `,a++}),i.forEach(p=>{const m=a===Pe,g=p.page;s+=`
...
`),s=n.length-1,a=n[s],r=8,i=20,l=16+a.length*r%(o.clientWidth-40),d=12+s*i-o.scrollTop;return{left:l,top:d}}function yi(o,e,t){const n=ln-2,s=o.selectionStart,a=o.value,r=`[${e}](#/page/${t})`;o.value=a.substring(0,n)+r+a.substring(s),o.focus(),o.selectionStart=n+r.length,o.selectionEnd=n+r.length,cn();const i=document.getElementById("live-preview-box");i&&(i.innerHTML=Et(o.value))}async function wi(o,e,t){const n=await He(o);if(!n)return;let s=n.content;const a=!!n.isEncrypted;if(a){if(!G){alert("Authentication Error: Decryption key is missing. Re-decrypt page first.");return}try{s=await me(s,G)}catch{alert("Decryption failure.");return}}let r=0;const i=/([-*+]\s+\[)([ xX])(\])/g,l=s.replace(i,(m,g,f,O)=>r===e?(r++,`${g}${t?"x":" "}${O}`):(r++,m));let d=l;a&&G&&(d=await ot(l,G)),n.content=d,n.updatedAt=Date.now(),n.signature=await Ze(n),await Me(n),pt.postMessage("refresh"),await Ae();const p=document.getElementById("main-content");p&&await hn(p)}function Vs(o){const e=[],t=/(?:\(|"|^|\s)#\/page\/([a-z0-9-_]+)/g;let n;for(;(n=t.exec(o))!==null;)e.push(n[1].toLowerCase());return Array.from(new Set(e))}async function vi(o){o.innerHTML=`
  ...
  `;const n=document.getElementById("master-unlock-form"),s=document.getElementById("master-unlock-input"),a=document.getElementById("master-unlock-error"),r=document.getElementById("master-unlock-wipe-btn"),i=document.getElementById("master-unlock-biometric-btn");setTimeout(()=>s==null?void 0:s.focus(),50),n.addEventListener("submit",async l=>{l.preventDefault(),a.classList.add("hidden");const d=s.value;try{const p=await Le(d);await St(p)?(de=p,Ks()):(a.classList.remove("hidden"),s.value="",s.focus(),await le("DECRYPT_FAIL","Master database unlock attempt with invalid passphrase."))}catch(p){a.textContent=`ERROR: ${p.message.toUpperCase()}`,a.classList.remove("hidden")}}),r.addEventListener("click",async()=>{confirm("CRITICAL ACTION: Are you sure you want to completely wipe this database? All encrypted records and system procedures will be permanently deleted.")&&prompt('Type "WIPE" to confirm sanitization:')==="WIPE"&&(await ms(),await so(),localStorage.removeItem("secops-wiki-db-encrypted"),localStorage.removeItem("secops-wiki-webauthn-gate"),localStorage.removeItem("secops-wiki-webauthn-payload"),localStorage.removeItem("secops-wiki-webauthn-salt"),de=null,o.remove(),alert("Database successfully wiped and reset to default plaintext configuration."),window.location.reload())}),i&&i.addEventListener("click",async()=>{await Ri()})}function Ks(){const o=document.getElementById("master-unlock-overlay");o&&o.remove(),le("SESSION_UNLOCK","Database session unlocked and decrypted at rest."),Ae().then(()=>{Fs(),qs(),window.addEventListener("hashchange",gn),window.addEventListener("online",mn),window.addEventListener("offline",mn),gn()})}function Ii(o){const e=async t=>{const n=new FileReader;n.onload=async()=>{const s=n.result.split(",")[1],a=`att-${Date.now()}-${Math.random().toString(36).substring(2,9)}`;let r=G||de,i=s;if(r)try{i=await ot(s,r)}catch(g){console.error("Failed to encrypt attachment:",g)}const l={id:a,name:t.name,mimeType:t.type,data:i};await Ea(l),await le("ATTACHMENT_SAVE",`Saved attachment ${t.name} (ID: ${a}, size: ${t.size} bytes).`);const d=t.type.startsWith("image/")?`![${t.name}](attachment://${a})`:`[Attachment: ${t.name}](attachment://${a})`,p=o.selectionStart,m=o.selectionEnd;o.value=o.value.substring(0,p)+d+o.value.substring(m),o.selectionStart=o.selectionEnd=p+d.length,o.dispatchEvent(new Event("input"))},n.readAsDataURL(t)};o.addEventListener("dragover",t=>{t.preventDefault()}),o.addEventListener("drop",async t=>{var s;t.preventDefault();const n=(s=t.dataTransfer)==null?void 0:s.files;if(n&&n.length>0)for(let a=0;a<n.length;a++)await e(n[a])}),o.addEventListener("paste",async t=>{var s;const n=(s=t.clipboardData)==null?void 0:s.items;if(n){for(let a=0;a<n.length;a++)if(n[a].kind==="file"){const r=n[a].getAsFile();r&&await e(r)}}})}async function Ai(o){const e=o.querySelectorAll('img[src^="attachment://"]');for(const n of Array.from(e)){const s=n.src.replace("attachment://","").split("/").pop()||"",a=await zo(s);if(a){const r=await ps(a);r&&(n.src=r)}}const t=o.querySelectorAll('a[href^="attachment://"]');for(const n of Array.from(t)){const s=n.href.replace("attachment://","").split("/").pop()||"",a=await zo(s);if(a){const r=await ps(a);r&&(n.href=r,n.download=a.name)}}}async function ps(o){let e=o.data;if(e.includes(":")){let t=null;if(G)try{t=await me(e,G)}catch{}if(!t&&de)try{t=await me(e,de)}catch{}if(!t)return null;e=t}try{const t=atob(e),n=new Uint8Array(t.length);for(let a=0;a<t.length;a++)n[a]=t.charCodeAt(a);const s=new Blob([n],{type:o.mimeType});return URL.createObjectURL(s)}catch(t){return console.error("Failed to parse base64 for attachment:",t),null}}async function Kn(){const o=document.getElementById("system-audit-logs-list");if(!o)return;const e=await Ta();if(e.length===0){o.innerHTML='<p class="text-xs font-mono text-slate-500">No security audit logs found.</p>';return}o.innerHTML=`
  ...
  `,e.classList.remove("hidden");const t=document.getElementById("sketch-canvas"),n=t.getContext("2d"),s=window.devicePixelRatio||1,a=600,r=350;t.width=a*s,t.height=r*s,t.style.width=`${a}px`,t.style.height=`${r}px`,n.scale(s,s),n.lineCap="round",n.lineJoin="round",n.strokeStyle="#ffffff",n.lineWidth=5,n.fillStyle="#060814",n.fillRect(0,0,a,r);let i=!1,l="pen",d="#ffffff",p=0,m=0,g;const f=[],O=[];f.push(n.getImageData(0,0,t.width,t.height));const U=x=>{const k=t.getBoundingClientRect(),F="touches"in x?x.touches[0].clientX:x.clientX,z="touches"in x?x.touches[0].clientY:x.clientY;return{x:(F-k.left)*(a/k.width),y:(z-k.top)*(r/k.height)}},I=x=>{i=!0;const k=U(x);p=k.x,m=k.y,g=n.getImageData(0,0,t.width,t.height),(l==="pen"||l==="eraser")&&(n.beginPath(),n.moveTo(p,m)),x.preventDefault()},P=x=>{if(!i)return;const k=U(x),F=parseInt(V.value,10);if(l==="pen"||l==="eraser")n.lineTo(k.x,k.y),n.strokeStyle=l==="eraser"?"#060814":d,n.lineWidth=F,n.stroke();else if(n.putImageData(g,0,0),n.beginPath(),n.strokeStyle=d,n.lineWidth=F,l==="line")n.moveTo(p,m),n.lineTo(k.x,k.y),n.stroke();else if(l==="arrow"){n.moveTo(p,m),n.lineTo(k.x,k.y),n.stroke();const z=Math.atan2(k.y-m,k.x-p),b=Math.max(10,F*2.5);n.beginPath(),n.moveTo(k.x,k.y),n.lineTo(k.x-b*Math.cos(z-Math.PI/6),k.y-b*Math.sin(z-Math.PI/6)),n.lineTo(k.x-b*Math.cos(z+Math.PI/6),k.y-b*Math.sin(z+Math.PI/6)),n.closePath(),n.fillStyle=d,n.fill()}else if(l==="rect")n.rect(p,m,k.x-p,k.y-m),n.stroke();else if(l==="circle"){const z=Math.sqrt(Math.pow(k.x-p,2)+Math.pow(k.y-m,2));n.arc(p,m,z,0,2*Math.PI),n.stroke()}x.preventDefault()},Z=()=>{i&&((l==="pen"||l==="eraser")&&n.closePath(),i=!1,f.push(n.getImageData(0,0,t.width,t.height)),O.length=0)},T=()=>{if(f.length>1){const x=f.pop();O.push(x);const k=f[f.length-1];n.putImageData(k,0,0)}},v=()=>{if(O.length>0){const x=O.pop();f.push(x),n.putImageData(x,0,0)}};t.addEventListener("mousedown",I),t.addEventListener("mousemove",P),window.addEventListener("mouseup",Z),t.addEventListener("touchstart",I,{passive:!1}),t.addEventListener("touchmove",P,{passive:!1}),window.addEventListener("touchend",Z);const y=x=>{x.ctrlKey&&x.key==="z"?(x.preventDefault(),T()):x.ctrlKey&&x.key==="y"&&(x.preventDefault(),v())};window.addEventListener("keydown",y);const E=["pen","eraser","line","arrow","rect","circle"],C=x=>{l=x,E.forEach(k=>{const F=document.getElementById(`draw-tool-${k}`);k===x?F.className="px-2 py-1 bg-teal-950/40 border border-teal-800 text-teal-400 font-mono text-[10px] rounded font-bold uppercase":F.className="px-2 py-1 bg-slate-900 border border-slate-850 text-slate-400 font-mono text-[10px] rounded hover:text-white uppercase"})};E.forEach(x=>{document.getElementById(`draw-tool-${x}`).addEventListener("click",()=>C(x))});const V=document.getElementById("draw-brush-size"),B=document.getElementById("draw-clear-btn"),$=document.getElementById("draw-cancel-btn"),W=document.getElementById("draw-save-btn"),ae=document.getElementById("draw-color-palette"),pe=document.getElementById("draw-undo-btn"),Ie=document.getElementById("draw-redo-btn");ae.addEventListener("click",x=>{const k=x.target.closest("button");k&&(d=k.getAttribute("data-color")||"#ffffff",ae.querySelectorAll("button").forEach(F=>F.classList.replace("border-white","border-transparent")),k.classList.replace("border-transparent","border-white"))}),B.addEventListener("click",()=>{confirm("Clear the canvas drawing?")&&(n.fillStyle="#060814",n.fillRect(0,0,a,r),f.push(n.getImageData(0,0,t.width,t.height)),O.length=0)}),pe.addEventListener("click",T),Ie.addEventListener("click",v);const ue=()=>{window.removeEventListener("mouseup",Z),window.removeEventListener("touchend",Z),window.removeEventListener("keydown",y),e.classList.add("hidden")};$.addEventListener("click",ue),W.addEventListener("click",()=>{const k=`![Tactical Sketch](${t.toDataURL("image/png")})`,F=o.selectionStart,z=o.selectionEnd;o.value=o.value.substring(0,F)+k+o.value.substring(z),o.selectionStart=o.selectionEnd=F+k.length,o.dispatchEvent(new Event("input")),ue()})}async function Ci(){if(!de){alert("Unlock Required: Unlock the database using your passphrase before registering biometric lock.");return}const o=prompt("Verify Identity: Enter your current master passphrase to bind to biometric unlock:");if(!o)return;const e=await Le(o);if(!await St(e)){alert("Verification Failed: Incorrect passphrase.");return}try{const n=crypto.getRandomValues(new Uint8Array(32)),s=await navigator.credentials.create({publicKey:{challenge:n,rp:{name:"SecOps Wiki",id:window.location.hostname||"localhost"},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"operator@secops.local",displayName:"SecOps Operator"},pubKeyCredParams:[{type:"public-key",alg:-7},{type:"public-key",alg:-257}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required"},timeout:6e4}});if(s){const a=new Uint8Array(s.rawId),r=Array.from(a).map(g=>g.toString(16).padStart(2,"0")).join(""),i=crypto.getRandomValues(new Uint8Array(32)),l=Array.from(i).map(g=>g.toString(16).padStart(2,"0")).join("");localStorage.setItem("secops-wiki-webauthn-salt",l);const d=`${r}:${l}`,p=await Le(d),m=await ot(o,p);localStorage.setItem("secops-wiki-webauthn-payload",m),localStorage.setItem("secops-wiki-webauthn-gate","true"),alert("Biometric credential successfully registered with WebAuthn platform gate."),await le("WEBAUTHN_REGISTER","Biometric credentials registered successfully."),zt(document.getElementById("main-content"))}}catch(n){alert(`Biometric registration failed: ${n.message}`),await le("WEBAUTHN_FAIL",`Biometric registration failed: ${n.message}`)}}async function Ri(){const o=localStorage.getItem("secops-wiki-webauthn-gate")==="true",e=localStorage.getItem("secops-wiki-webauthn-payload");if(!o||!e){alert("Biometric Unlock is not registered. Setup biometric credentials in settings first.");return}try{const t=crypto.getRandomValues(new Uint8Array(32)),n=await navigator.credentials.get({publicKey:{challenge:t,rpId:window.location.hostname||"localhost",userVerification:"required",timeout:6e4}});if(n){const s=new Uint8Array(n.rawId),a=Array.from(s).map(g=>g.toString(16).padStart(2,"0")).join(""),r=localStorage.getItem("secops-wiki-webauthn-salt")||"";if(!r)throw new Error("Biometric decryption salt is missing from storage.");const i=`${a}:${r}`,l=await Le(i),d=await me(e,l),p=await Le(d);await St(p)?(de=p,Ks()):alert("Biometric validation failed: Stored credentials mismatch.")}}catch(t){alert(`Biometric verification failed: ${t.message}`),await le("WEBAUTHN_FAIL",`Biometric unlock failed: ${t.message}`)}}function Di(o){const e={name:"Root",fullPath:"",children:{},pages:[]};for(const t of o)for(const n of t.tags){const s=n.split("/");let a=e,r="";for(let i=0;i<s.length;i++){const l=s[i].trim();l&&(r=r?`${r}/${l}`:l,a.children[l]||(a.children[l]={name:l,fullPath:r,children:{},pages:[]}),a=a.children[l])}a.pages.push(t)}return e}function Ys(o,e=0){let t="";const n=Object.keys(o.children).sort();for(const s of n){const a=o.children[s];if(!(Object.keys(a.children).length>0||a.pages.length>0))continue;const i=a.fullPath;t+=`
      <div class="tree-folder">
        ...
        <div class="tree-folder-children hidden pl-3.5 space-y-0.5 animate-fade-in" data-path="${_(i)}">
          ${Ys(a,e+1)}
          ${a.pages.map(l=>{const d=ne===l.slug&&!Xe,p=l.isEncrypted&&!G&&nt,m=p?"[REDACTED CORE]":l.title;return`
    ...
    `}return t}function $i(o){o.querySelectorAll("code.language-javascript-sandbox, code.language-html-sandbox").forEach(t=>{const n=t.parentElement;if(!n||n.tagName.toLowerCase()!=="pre"||n.querySelector(".sandbox-run-btn"))return;const s=t.classList.contains("language-html-sandbox"),a=t.textContent||"",r=document.createElement("button");r.className="sandbox-run-btn absolute top-2 right-12 px-2 py-0.5 bg-teal-950/40 border border-teal-800 text-teal-400 hover:text-teal-300 font-mono text-[9px] rounded uppercase font-bold transition z-10",r.textContent="Run Sandbox",n.classList.add("relative"),n.appendChild(r);const i=document.createElement("div");i.className="sandbox-iframe-wrapper mt-2 hidden border border-slate-800 rounded-lg overflow-hidden bg-slate-950",n.after(i),r.addEventListener("click",()=>{var d;if(i.classList.toggle("hidden"))r.textContent="Run Sandbox",i.innerHTML="";else{r.textContent="Close Sandbox",i.innerHTML=`
        ...
        `;const p=i.querySelector("iframe");let m="";s?m=a:m=`
            <!DOCTYPE html>
            <html>
              <head>
                <style>
...
Click Cancel to import it as a duplicate under an auto-generated title.`)){let I=1;for(;f;)g=`${m}-${I}`,f=await He(g),I++}const O={slug:g,title:p.title,content:p.content,tags:p.tags,updatedAt:Date.now()};O.signature=await Ze(O),await Me(O),await le("P2P_IMPORT_SUCCESS",`Imported decrypted page: ${p.title} (slug: ${g})`),alert("Intel Entry imported successfully."),window.location.hash=`#/page/${g}`})}catch(i){o.innerHTML=`<div class="glass-panel border border-red-950 p-6 rounded-xl text-center font-mono text-xs text-red-400">P2P DECRYPTION ERROR: ${_(i.message)}</div>`}}document.addEventListener("DOMContentLoaded",ti);async function Oi(){setInterval(async()=>{try{const o=ce;await Aa({id:Date.now().toString(),timestamp:Date.now(),data:JSON.stringify(o)}),console.log("Background backup created")}catch(o){console.error("Backup failed",o)}},24*60*60*1e3)}Oi();window.renderKnowledgeGraph=function(o){const e=document.getElementById(o);if(!e)return;const t=e.getContext("2d");t&&(t.fillStyle="#fff",t.fillText("Knowledge Graph (Mock)",10,20))};
