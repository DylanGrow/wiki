const r=self,a="secops-wiki-v1.1.0",c=["/wiki/","/wiki/index.html","/wiki/manifest.json","/wiki/icon.svg","/wiki/assets/favicon-CZuJCmGV.ico","/wiki/assets/icon-L9ClnIqC.svg","/wiki/assets/main-C4L1DU-l.css","/wiki/assets/main-CDEN6_iu.js","/wiki/assets/manifest-BsCIBjQx.json"],h=`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
