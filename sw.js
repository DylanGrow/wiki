const r=self,a="secops-wiki-v1.1.0",c=["/wiki/","/wiki/index.html","/wiki/manifest.json","/wiki/icon.svg","/wiki/assets/favicon-CZuJCmGV.ico","/wiki/assets/icon-DzVj_n3s.svg","/wiki/assets/main-Cw9hsC_3.css","/wiki/assets/main-DR3UCWnf.js","/wiki/assets/manifest-BsCIBjQx.json"],h=`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
